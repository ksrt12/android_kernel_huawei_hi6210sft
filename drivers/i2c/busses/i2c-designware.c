...
static void i2c_dw_dma_rx_callback(void *data)
{
	...
	/* Sync in buffer */
	dma_sync_sg_for_cpu(dev->dev, &dmarx->sg, 1, DMA_FROM_DEVICE);/*DTS2013092705189 j00207786 2013-09-27*/
...
static void i2c_dw_init(struct dw_i2c_dev *dev)
{
	...
	/*DTS2013070307923 solve I2C communiction with sensor w00215368 */
...
/* BEGIN PN:DTS2014073104965,Added by lihai, 2014/7/31*/
...
/* END   PN:DTS2014073104965,Added by lihai, 2014/7/31*/
/* print reg*/
...
/*lint -e666*/
	...
	for_each_set_bit(i, &abort_source, ARRAY_SIZE(abort_sources))
		dev_err(dev->dev, "%s: %s\n", __func__, abort_sources[i]);
/*lint +e666*/
	/* BEGIN PN: DTS2014073104965,Modified by lihai, 2014/7/31*/
	if (abort_source & DW_IC_TX_ARB_LOST)
	{
		i2c_print_controller_reg_test(dev);
		return -EAGAIN;
	}
	/* END   PN: DTS2014073104965,Modified by lihai, 2014/7/31*/

...
static struct battery_aging_safe_policy {
    ...
    {BASP_LEVEL_3,  50000,    6,      200,    6},
    {BASP_LEVEL_2,  40000,    8,      50,     8},
    {BASP_LEVEL_1,  30000,    9,      0,      9},
...
/*DTS:DTS2014080803665 z00269720 2014-08-07 begin*/
/**********************************************************
...
/*DTS:DTS2014080803665 z00269720 2014-08-07 end*/
...
static int __init move_pmu_nv_info(void)
{
    ...
    /*BEGIN PN: DTS2014092911047  DTS20140930 Modified by xxx 20140930*/
     #ifdef CONFIG_ARM64
    ...
    #endif
    /*END PN:DTS2014092911047 DTS20140930 Modified by xxx 20140930*/
...
/*DTS: DTS2014092402583 by d00273657 2014.10.23 begin*/
/*******************************************************
...
/*DTS: DTS2014092402583 by d00273657 2014.10.23 end*/
...
/*DTS:DTS2014071701443 z00269720 2014-07-17 end*/
/*******************************************************
		...
		int batt_temp, int rbatt_tbl, int fcc_uah)
{
    ...
    int batt_temp_degc = batt_temp/10;
    int ratio = 0;
    /*DTS:DTS2014092402583  d00273657 2014-10-22 begin*/
    unsigned char use_delta_rc_flag = USE_DELTA_RC_SCENE;
    /*DTS:DTS2014092402583  d00273657 2014-10-22 end*/
    struct vcdata vc = {0};
    if( NULL == di )
    {
        hwlog_info("NULL point in [%s]\n", __func__);
...
static int calculate_state_of_charge(struct smartstar_coul_device *di)
{
    ...
    int rbatt;
    int temp;
	/*DTS:DTS2014083000501 z00269720 2014-07-17 begin*/
	int soc_no_uuc, soc_before_adjust, soc_before_limit;
	/*DTS:DTS2014083000501 z00269720 2014-07-17 end*/
 ...
 static void calculate_soc_work(struct work_struct *work)
{
    ...
    int evt;
    int ret = -1;
    /*BEGIN PN:DTS2014093003719 Added by l00189337 20141004*/
    short offset_cur_modify_val = 0;
    /*END PN:DTS2014093003719 Added by l00189337 20141004*/
...
/* adjust rm */
    if (rm > fcc_101){
        ...
        save_cc_uah(cc);
        di->batt_limit_fcc = 0;
        /*DTS:DTS2014102401492 d00273657 2014.10.28 begin*/
        di->is_nv_need_save = 1;
        /*DTS:DTS2014102401492 d00273657 2014.10.28 end*/
    }
...
/* check coulomb version */
    ...
    /* get smartstar V300 work mode DTS2014021801323 */

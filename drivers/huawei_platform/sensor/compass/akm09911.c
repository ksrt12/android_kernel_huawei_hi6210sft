...
/* BEGIN PN: DTS2014031803623 , Modified by f00184246,2014-3-18*/
...
static int akm_self_test_body(struct akm_compass_data *akm)
{
	...
	int count;
	int ret;
	/* < DTS2014122200599 wangcunyou 20141222 begin */
	compass_INFO("[COMPASS]%s:%d : akm self test begin \n", __FUNCTION__, __LINE__);
	/* DTS2014122200599 wangcunyou 20141222 end > */
	/* < DTS2014091200316 wanghang 20140923 begin */
	mutex_lock(&akm->self_test_mutex);
	/* DTS2014091200316 wanghang 20140923 end > */

	/* <DTS2014082204736 hufeng 20140822 begin */
	/* Removed lines. */
	/* DTS2014082204736 hufeng 20140822 end> */
...
/* END PN:DTS2014090405836,Modified by szz, 2014/9/4*/

/* BEGIN PN:DTS2014030102308  ,Added by F00184246, 2014/3/1*/ 
/*< DTS2012070507052 sunlibin 20120705 begin */
/* < DTS2012022405847 zhangmin 20120224 begin */
/* < DTS2013030405297 gefangyong 20130305 begin */
...
/* BEGIN PN:DTS2014090405836,Modified by szz, 2014/9/4*/
...
/* <DTS2012072506776 sunlibin 20120726 begin */
...
/* DTS2012072506776 sunlibin 20120726 end> */
...
/*DBG */
/* < DTS2012111205616 zhangmin 20121112 begin */
...
/* DTS2012111205616 zhangmin 20121112 end > */
...
/* < DTS2013050201362 zhangmin 20130502 begin */
static atomic_t kxtik_status_flag;
/* DTS2013050201362 zhangmin 20130502 end > */
...
{
    /*< DTS2012053102649 jiangweizheng 20120531 begin */
/* BEGIN PN:DTS2014100901175,add by szz, 2014/10/09*/
    int val;
#if defined (CONFIG_HUAWEI_DSM)
...
/* END PN:DTS2014100901175,add by szz, 2014/10/09*/
    ...
    return val;
    /* DTS2012053102649 jiangweizheng 20120531 end >*/
}
...
{
       /* < DTS2013092603873 guoyun 20130927 begin  */
       /* coverity: remove unuseful code to avoid coverity error */
       /* DTS2013092603873 guoyun 20130927 end > */
...
{	
	...
	/* < DTS2013123103089 caowei 20131231 begin */
	{
	...
	/* DTS2013123103089 caowei 20131231 end >*/
...
static int gs_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	/* BEGIN PN:DTS2014030102308  ,Modified by F00184246, 2014/3/4*/ 
	//memcpy(pdata, client->dev.platform_data, sizeof(struct kx023_platform_data));
	/* END PN:DTS2014030102308  ,Modified by F00184246, 2014/3/4*/ 
	...
	//provide by company
	/*BEGIN PN:DTS2014042903909 ,modified by f00184246, 2014/04/29*/
	...
	/*END PN:DTS2014042903909 ,modified by f00184246, 2014/04/29*/
...
/* DTS2013030405297 gefangyong 20130305 end > */
/* DTS2012022405847 zhangmin 20120224 end > */
/* DTS2012070507052 sunlibin 20120705 end >*/
/* END PN:DTS2014030102308  ,Added by F00184246, 2014/3/1*/ 
/* END PN:DTS2014090405836,Modified by suzhanzheng, 2014/9/4*/

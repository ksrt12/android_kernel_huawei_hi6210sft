 ...
 * =====================================================================================
 *
 *       Filename:  log-usertype.c
 *
 *    Description:  add for kernel to know whether it is beta version or not
 *
 *        Version:  1.0
 *        Created:  11/27/2015 16:11:16 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  shenchenkai (s00181365), shenchenkai@huawei.com
 *   Organization:  Huawei
 *
 * =====================================================================================
 */

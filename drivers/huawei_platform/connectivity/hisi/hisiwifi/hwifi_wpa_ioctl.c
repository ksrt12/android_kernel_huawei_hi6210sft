...
/*
 * Prototype    : set_p2p_wps_ie
 * Description  : set p2p wps ie information to device
 * Input        : wifi_wpa_ioctl_data_struct *ioctl_data
...
/* DTS2014050806333 HI1101 bug fix 2014-6-13 end */
    ...
    switch(ioctl_data.cmd)
    {
        ...
        case HWIFI_WPA_IOCTL_CMD_AP_POWER_OFF:
            ...
            /* DTS2013111801692   Hi110x bug fix z00209041 20131118  begin */
            hi110x_wakelocks_release_detect(hi110x_dev->pm_info);
            /* DTS2013111801692   Hi110x bug fix z00209041 20131118  end */

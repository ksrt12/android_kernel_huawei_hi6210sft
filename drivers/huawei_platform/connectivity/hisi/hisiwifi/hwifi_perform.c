 ...
 ******************************************************************************
  ...
  函数列表   :
              ...
              hwifi_perform_rx_network_bypass
              hwifi_perform_rx_network_statistic
              hwifi_perform_rx_sdio_bypass
              hwifi_perform_rx_sdio_statistic
              hwifi_perform_tx_network_bypass
              hwifi_perform_tx_network_statistic
              hwifi_perform_tx_sdio_bypass
              hwifi_perform_tx_sdio_statistic
  修改历史   :
  1.日    期   : 2013年3月23日
    作    者   : 张华 00209041
    修改内容   : 创建文件
...
/*****************************************************************************
 函 数 名  : hwifi_perform_init_rx_statistic
 功能描述  : 初始化接收用统计变量，包括帧个数，时间和累计帧长度
 输入参数  : void
 输出参数  : 无
 返 回 值  : void
 调用函数  :
...
/*****************************************************************************
 函 数 名  : hwifi_perform_calc_rx_throughput
 功能描述  : 计算接收路径上的吞吐量，包括SDIO和网络部分
 输出参数  : 无
 返 回 值  : static void
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : hwifi_perform_rx_sdio_statistic
 功能描述  : 进行SDIO接收处的统计
 输入参数  : struct hi110x_device *hi110x_dev
             uint32 len
 输出参数  : 无
 返 回 值  : void
 调用函数  :
...
void hwifi_perform_rx_sdio_statistic(struct hi110x_device *hi110x_dev, uint32 len)
{
    ...
    /* zhanghua 00209041 2013-03-23 B295  需要判定WiFi成功，才进行统计。未关联时统计没有价值*/
...
/*****************************************************************************
 函 数 名  : hwifi_perform_rx_network_statistic
 功能描述  : 网络转发统计
 输入参数  : struct hi110x_device *hi110x_dev
             uint32 len
 输出参数  : 无
...
/*****************************************************************************
 函 数 名  : hwifi_perform_rx_sdio_bypass
 功能描述  : SDIO接收 处理后，阶段SDIO之后的接收处理，包括网络转发、内核和应用
 输入参数  : struct hi110x_sdio *hi_sdio
...
/*****************************************************************************
 函 数 名  : hwifi_perform_rx_network_bypass
 功能描述  : 网络处理后，阶段之后处理，包括内核和应用
 输入参数  : struct hi110x_device *hi110x_dev
             struct sk_buff *skb
 输出参数  : 无
 返 回 值  : void
...
/*****************************************************************************
 函 数 名  : hwifi_perform_calc_tx_throughput
 功能描述  : 包括发送部分的吞吐量，包括网络和SDIO 部分
 输出参数  : 无
 返 回 值  : static void
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : hwifi_perform_tx_sdio_bypass
 功能描述  :
 输入参数  : 无
 输出参数  : 无
 返 回 值  :
...
{
/* zhanghua 00209041 2013-03-23 B295  内存不需要本函数释放*/

}


/*****************************************************************************
 函 数 名  : hwifi_perform_tx_sdio_statistic
 功能描述  :
 输入参数  : 无
 输出参数  : 无
 返 回 值  :
...
/*****************************************************************************
 函 数 名  : hwifi_perform_init_rwtotal_statistic
 功能描述  : 初始化读写用统计变量，包括帧个数，时间和累计帧长度
 输入参数  : void
 输出参数  : 无
 函 数 名  : bus_transfer
 功能描述  : 实现SDIO发送的统计和ByPass挂接。其中ByPass后，不影响统计本接口吞吐量
 修改历史      :
  1.日    期   : 2013年8月14日
    作    者   : 张华 00209041
    修改内容   : 新生成函数
...
/*****************************************************************************
 函 数 名  : hwifi_perform_rwtotal_sdio_statistic
 功能描述  :
 输入参数  : 无
 输出参数  : 无
 返 回 值  :
...
void hwifi_perform_calc_rwtotal_throughput(uint32 len)
{
    ...
    /* DTS2013112102514  Hi110x bug fix zhouxinfeng/zwx165479 2013/11/21 begin */
    sdio_rate   = total_bits/(sdio_dur_us?:1);
    pps_rate    = (pps_cal_cnt*1000000)/(sdio_dur_us?:1);
    /* DTS2013112102514  Hi110x bug fix zhouxinfeng/zwx165479 2013/11/21 end */
...
/*
 * Prototype    : hcc_init_filter_tcp_ack_pool
 * Description  : init tcp ack pool
 * Input        : struct hcc_handler* hcc
 *
 * Output       : None
 * Return Value : void
...
int32 hwifi_perform_tcp_ack_filter(struct sk_buff *skb, struct hcc_handler *hcc, hcc_chan_type dir)
{
    ...
    /* DTS2013110801777  Hi110x bug fix  houyin/h00217255  2013/11/25 begin */
    #if 0
    ...
    /* DTS2013110801777  Hi110x bug fix  houyin/h00217255  2013/11/25 end */

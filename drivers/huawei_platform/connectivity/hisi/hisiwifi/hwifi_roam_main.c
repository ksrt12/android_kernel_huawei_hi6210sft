...
/*
 * Prototype    : roam_need_data_buffering
 * Description  :
 * Input        :
 * Output       : None
 * Return Value :
...
/*
 * Prototype    : roam_start_buffering
 * Description  :
 * Input        :
 * Output       : None
 * Return Value :
...
/*
 * Prototype    : roam_clean_buffering
 * Description  :
 * Input        :
 * Output       : None
 * Return Value :
...
/*
 * Prototype    : send_buffering_work_func
 * Description  :
 * Input        :
 * Output       : None
 * Return Value :
...
/*
 * Prototype    : roam_update_scan_channels
 * Description  :
 * Input        :
 * Output       : None
 * Return Value :
...
{
    /* DTS2014070308446 HI1101 bug fix 2014-7-9 begin */
    struct cfg_struct *cfg;
...
/* DTS2014070308446 HI1101 bug fix 2014-7-9 end */

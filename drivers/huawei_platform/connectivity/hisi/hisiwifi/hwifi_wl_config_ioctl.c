...
/* DTS2013101203050 聚合个数动态调整 2013/11/26 */
...
/*
 * Prototype    : wl_amsdu_certify_set
 * Description  : amsdu certify mode set
 * Input        : struct cfg_struct *cfg,uint8 enabled
 *                uint8 enabled
 * Output       : None
 * Return Value : int32
...
/*
 * Prototype    : wl_wmm_ac_opt_set
 * Description  : wmm ac opt set
 * Input        : struct cfg_struct *cfg,uint8 enabled
 *                uint8 enabled
 * Output       : None
 * Return Value : int32
...
/* DTS2014031708932 Hi1101 bug fix zhanglu/z00217036  2014/3/21 begin*/
/*
...
/* DTS2014031708932 Hi1101 bug fix zhanglu/z00217036  2014/3/21 end*/
...
/*
 * Prototype    : wl_runtc_get
 * Description  : get current test case
 * Input        : struct cfg_struct *cfg
 *
 * Output       : None
 * Return Value : uint8
...
/*
 * Prototype    : wl_amsdu_certify_get
 * Description  : get amsdu certify mode
 * Input        : struct cfg_struct *cfg
 *
 * Output       : None
 * Return Value : uint8
...
/*
 * Prototype    : wl_psm_certify_get
 * Description  : get psm certify mode
 * Input        : struct cfg_struct *cfg
 *
 * Output       : None
 * Return Value : uint8
...
/*
 * Prototype    : wl_wmm_ac_opt_get
 * Description  : get wmm ac opt mode
 * Input        : struct cfg_struct *cfg
 *
 * Output       : None
 * Return Value : uint8
...
/* DTS2014070825511 Hi110x bug fix luolingzhi/l00225940 2014/9/5 begin */
/*
 * Prototype    : wl_link_statis_cfg_get
 * Description  : get link statistic info
 * Input        : struct cfg_struct *cfg, struct wifi_ioctl_data_struct *ioctl_data
 * Output       : NONE
 * Return Value : struct stats_struct *
 * Calls        :
 * Called By    :
 *
 *   History        :
...
/* DTS2014070825511 Hi110x bug fix luolingzhi/l00225940 2014/9/5 end */

/*
 * Prototype    : hwifi_wl_config_ioctl_cmd
 * Description  : deal with ioctl cmd
...
int32 hwifi_wl_config_ioctl_cmd(struct hi110x_device* hi110x_dev, struct ifreq *ifr, int32 cmd)
{
    ...
    /* DTS2014090101675 Hi1101 bug fix 20140902 d00223710 begin */
    ...
    /* DTS2014090101675 Hi1101 bug fix 20140902 d00223710 end */
    ...
    switch(ioctl_data.cmd)
    {
        ...
        /* DTS2014091804613 Hi110x bug fix luolingzhi/l00225940 2014/9/22 begin */
        case HWIFI_IOCTL_CMD_WMM_AC_OPT_SET:
               ret = wl_wmm_ac_opt_set(hi110x_dev->hcc, ioctl_data.pri_data.wmm_ac_opt_enabled);
               break;
        /* DTS2014091804613 Hi110x bug fix luolingzhi/l00225940 2014/9/22 end */
        ...
        case HWIFI_IOCTL_CMD_AGGRE_CFG_SET:
            ...
            /* DTS2013101203050 聚合个数动态调整iw_confg测试接口 2013/11/26 begin */

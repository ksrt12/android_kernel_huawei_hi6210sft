...
/* DTS2013121802132 Hi1101 bug fix xudayong/x00202101 begin */
#include "hi110x_pm.h"
/* DTS2013121802132 Hi1101 bug fix xudayong/x00202101 end */
...
/* DTS2013121906184 Hi1101 bug fix xudayong/x00202101 begin */
extern int32 hwifi_report_diconnect_res(struct cfg_struct *cfg, uint16 reason);
/* DTS2013121906184 Hi1101 bug fix xudayong/x00202101 end */
...
/*
 * Prototype    : dev_netlink_send_atomic
 * Description  : send netlink data
 * Input        : void
 * Return Value : int
 * Calls        :
...
/*
 * Prototype    : hwifi_reduce_bt_priority
 * Description  : reduce bt priority
 * Input        : void
 * Return Value : int
 * Calls        :
 * Called By    :
...
/*  DTS2013120304239 Hi1101 bug fix dengwenhua/d00223710 begin */
    hwifi_ap_deinit(cfg);
/*  DTS2013120304239 Hi1101 bug fix dengwenhua/d00223710 end */
...
/*DTS2013122804682   Hi110x bug fix zhouxinfeng/z00262551 2014/1/2 begin */
/*
 * Prototype    : hwifi_exception_enable_set
 * Description  : enable/disable wifi exception
 * Input        : struct hcc_handler *hcc, int32 enable
 * Return Value : int32 the exception_enable stat before set.
 * Calls        :
 * Called By    :
 *
 *   History        :
...
int hwifi_exception_submit(struct hcc_handler *hcc)
{
    ...
    /* DTS2013111803333  Hi110x bug fix zhouxinfeng/zwx165479 2013/11/20 begin */
    ...
    spin_unlock_irqrestore(&hcc->excp_lock, flags);
    return ret;
    /* DTS2013111803333  Hi110x bug fix zhouxinfeng/zwx165479 2013/11/20 end */
}
/* DTS2013111203860  Hi110x bug fix zhouxinfeng/zwx165479 2013/11/12 begin */
/* DTS2013111505974  Hi110x bug fix zhouxinfeng/zwx165479 2013/11/15 begin */
...
/* DTS2013111505974  Hi110x bug fix zhouxinfeng/zwx165479 2013/11/15 end */

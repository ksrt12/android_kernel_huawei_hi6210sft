...
/*
 * Prototype    : hwifi_fill_teardown
 * Description  : teardown wid set
 * Input        : struct set_teardown_wid *set_teardown
 * Output       : None
 * Return Value : void
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hwifi_set_teardown
 * Description  : set the wid to clear AMPDU information
...
/*
 * Prototype    : convert_ac_to_tid
 * Description  : convert ac value to TID for Ittiam
 * Input        : uint8 traffic_class
 * Output       : None
 * Return Value : uint8
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hwifi_set_amsdu
 * Description  : set the wid to clear AMPDU information
 * Input        : struct cfg_struct *cfg, struct aggre_cfg_param *param
 * Output       : NONE
 * Return Value : int32
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hwifi_fill_start_ampdu
 * Description  : fill set ampdu wid
 * Input        : struct set_ampdu_wid *set_ampdu, struct aggre_cfg_param *param
 * Output       : NONE
 * Return Value : void
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hwifi_fill_end_ampdu
 * Description  : fill set ampdu wid
 * Input        : struct set_ampdu_wid *set_ampdu, struct aggre_cfg_param *param
 * Output       : NONE
 * Return Value : void
...
/*
 * Prototype    : hwifi_set_ampdu
 * Description  : set ampdu
 * Input        : struct cfg_struct *cfg, struct aggre_cfg_param *param
 * Output       : NONE
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : wl_set_ba
 * Description  : notice device that start to use ba
 * Input        : struct cfg_struct *cfg
 * Output       : NONE
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : wl_set_ampdu
 * Description  : notice device that start to use ampdu
 * Input        : struct cfg_struct *cfg
 * Output       : NONE
 * Return Value : int32
 * Calls        :
...
/* DTS2013101203050 聚合个数动态调整 2013/11/26 begin */
/*
...
/* DTS2013101203050 聚合个数动态调整 2013/11/26 end */
...
STATIC void hwifi_data_rate_timeout(unsigned long data)
{
    ...
    {
        /* DTS2013102407178 sony lt18i兼容性问题修改 2013/11/26 */
...
void hwifi_aggr_init(struct cfg_struct *cfg)
{
    ...
    /* DTS2013110402060  Hi110x bug fix xudayong/x00202101 2013/11/20 begin */
    ...
    /* DTS2013110402060  Hi110x bug fix xudayong/x00202101 2013/11/20 end */
}

...
struct hwifi_inform_ops
{
   ...
   /* void  (*status_ready_result)(struct cfg_struct *cfg, struct hwifi_status_ready_stru *event);  add by z00217036 */
...
/*
 * Prototype    : hwifi_get_connect_status
 * Description  : transform our connect results to kernal connect results
 * Input        : None
 * Output       : None
 * Return Value : uint16
 * Calls        :
...
/*
 * Prototype    : hwifi_update_scan_time
 * Description  :
 * Input        : None
 * Output       : None
 * Return Value :
...
/*
 * Prototype    : hwifi_disconnect_result
 * Description  : report disconnect result
 * Input        : None
 * Output       : None
 * Return Value : void
 * Calls        :
...
#endif
    /* DTS2014012203891   Hi110x bug fix 杭天奇 hwx160629 2014/01/23 begin */
    cancel_delayed_work_sync(&cfg->pwrm_set_work);
    /* DTS2014012203891   Hi110x bug fix 杭天奇 hwx160629 2014/01/23 end */
...
/*
 * Prototype    : hwifi_init_param_result
 * Description  : report init beacon result
 * Input        : None
 * Output       : None
 * Return Value :
 * Calls        :
...
/*
 * Prototype    : hwifi_save_channel_info
 * Description  : get current channel info
 * Input        : struct cfg_struct *cfg
                : int8 *buf
                : int32 len
 * Output       : None
...
/*
 * Prototype    : hwifi_dev_ready_event
 * Description  : report device status ready beacon result
 * Input        : None
 * Output       : None
 * Return Value :
 * Calls        :
...
{
    int32 i, ret;
/* DTS2013120903045 Hi1101 bug fix xudayong/x00202101 begin */
    int8 band_rule_found;
/* DTS2013120903045 Hi1101 bug fix xudayong/x00202101 end */
...
/*
 * Prototype    : report_connect_event
 * Description  :
 * Input        :
...
/*
 * Prototype    : report_disconnect_event
 * Description  :
 * Input        :
...
/*
 * Prototype    : report_sta_join_event
 * Description  :
 * Input        :
...
/*
 * Prototype    : report_sta_leave_event
 * Description  :
 * Input        :
...
/*
 * Prototype    : report_change_mode_resp
 * Description  :
 * Input        :
...
/*
 * Prototype    : report_set_param_resp
 * Description  :
 * Input        :
...
/*
 * Prototype    : report_init_param_resp
 * Description  :
 * Input        :

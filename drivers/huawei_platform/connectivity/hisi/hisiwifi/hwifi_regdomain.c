...
const struct ieee80211_regdomain g_hwifi_regdom = {
    ...
    /* DTS2015012805708 Hi110x bug fix luolingzhi/l00225940 2015/01/31 begin */
    ...
    NL80211_RRF_NO_OFDM),
    */
    /* DTS2015012805708 Hi110x bug fix luolingzhi/l00225940 2015/01/31 end */
 ...
 */
 /*
 * Prototype    : hwifi_regdomain_freq_range_get
 * Description  : hwifi regulatory freq range get
 * Input        : uint32 start_freq, uint32 end_freq
 * Output       :
 * Return Value : uint8 freq_range
 * Calls        :
 * Called By    :
 *
 *   History        :
...
/*
 * Prototype    : hwifi_regdomain_chan_get
 * Description  : hwifi regulatory channel map get
 * Input        : uint32 start_freq, uint32 end_freq, uint8 freq_range, uint8 bw
 * Output       : channel map
 * Return Value : None
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hwifi_regdomain_find_db
 * Description  : get hwifi regulatory data base to get rules
 * Input        : struct regulatory_request *request, int32 *db_index
 * Output       : None
 * Return Value : int32
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hwifi_regdomain_get_bw_map
 * Description  : hwifi regdomain get bandwidth map from regdomain rules
 * Input        :
 * Output       : None
 * Return Value : uint8
 * Calls        :
 ...
 */
 ...
 /*
 * Prototype    : hwifi_regdomain_fill_country_code
 * Description  : hwifi regdomain rules to firmware, fill country code
 * Input        : const struct ieee80211_regdomain *regdom, struct hwifi_regdom_msg_wid *regdom_msg
 * Output       : None
 * Return Value : void
 * Calls        :
 * Called By    :
                                                          ...
                                                          const uint8                          *country_code)
{
 ...
 /*
 * Prototype    : hwifi_regdomain_fill_radar_code
 * Description  : hwifi regdomain rules to firmware, fill radar code
 * Input        : struct hwifi_regdom_msg_wid *regdom_msg, int32 db_index
 * Output       : None
 * Return Value : void
 * Calls        :
 * Called By    :
                                                       ...
                                                       int32                                 db_index)
{
 ...
 /*
 * Prototype    : hwifi_regdomain_fill_rc_bmap
 * Description  : hwifi regdomain rules to firmware, fill regulatory class bmap
 * Input        : const struct ieee80211_regdomain *regdom, struct hwifi_regdom_msg_wid *regdom_msg
 * Output       : None
 * Return Value : void
 * Calls        :
...
/*
 * Prototype    : hwifi_regdomain_fill_rc_info
 * Description  : fill regulatory class info
 * Input        : const struct ieee80211_regdomain *regdom, struct hwifi_regdom_msg_wid *regdom_msg
 * Output       :
 * Return Value : None
 * Calls        :
...
/*
 * Prototype    : hwifi_regdomain_send_to_firmware
 * Description  : cfg80211 regulatory domain send to firmware
 * Input        : struct wiphy handle, struct regulatory_request
 * Output       : None
 * Return Value : int32
 * Calls        :
 * Called By    :
...
int32 hwifi_regdomain_send_to_firmware(struct wiphy *wiphy, struct regulatory_request *request)
{
...
#ifdef __ROAM__
    /* DTS2014062300914 HI1101 bug fix 2014-6-23 begin */
    ...
    /* DTS2014062300914 HI1101 bug fix 2014-6-23 end */
#endif
    ...
    /* DTS2013112601282 Hi110x bug fix xudayong/x00202101 2013/11/27 begin */
    cfg->regdom = regdom;
    /* DTS2013112601282 Hi110x bug fix xudayong/x00202101 2013/11/27 end */

    return ret;
}

/*
 * Prototype    : hwifi_regdomain_isalpha_upper
 * Description  : check user ioctl country code if correct letter
 * Input        : char letter
 *              :
 * Output       : None
 * Return Value : int
...
/*
 * Prototype    : hwifi_regdomain_isalpha2
 * Description  : check user input country code if correct alpha2
 * Input        : struct cfg_struct *cfg
 *              : const int8 *country_code
 * Output       : None
 * Return Value : int
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hwifi_regdomain_isdefault
 * Description  : check country code if default
 * Input        : struct cfg_struct *cfg
 *              : const int8 *country_code
 * Output       : None
 * Return Value : int
...
/* DTS2013121905027   Hi110x bug fix hWX160629 2013/12/23 end */

/*
 * Prototype    : hwifi_regdomain_update
 * Description  : hwifi regulatory domain update request
 * Input        : struct cfg_struct *cfg, const uint8 *country_code
 * Output       : None
 * Return Value : None
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hwifi_regdomain_update_by_ie
 * Description  : hwifi regulatory domain update by country ie
 * Input        : cfg handle, bssid, resp_ie, resp_ie_len
 * Output       : succ or fail
 * Return Value : None
 * Calls        :
 * Called By    :
 ...
 *
 */
 /* DTS2013111106142 & DTS2013111400904 Hi110x bug fix l00225940 2013/11/14 */

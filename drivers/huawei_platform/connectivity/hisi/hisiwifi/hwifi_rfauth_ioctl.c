 ...
 *
 *
 * File Name     : hwifi_android_ioctl.c
...
/*
 * Prototype    : wl_uchannel_set
 * Description  : set uchannel info
 * Input        : struct cfg_struct *cfg
                : int32 channel_info
 * Output       : None
 * Return Value : int
...
/*
 * Prototype    : wl_uchannel_get
 * Description  : get uchannel info
 * Input        : struct cfg_struct *cfg
 * Output       : None
 * Return Value : uint16
 * Calls        :
...
/*
 * Prototype    : wl_rfupc_set
 * Description  : set rfupc info
 * Input        : struct cfg_struct *cfg
                : int32 rfupc_info
 * Output       : None
 * Return Value : int
...
/*
 * Prototype    : wl_rfupc_get
 * Description  : get rfupc info
 * Input        : struct cfg_struct *cfg
 * Output       : None
 * Return Value : uint16
 * Calls        :
...
/*
 * Prototype    : wl_scalea_set
 * Description  : set scalea info
 * Input        : struct cfg_struct *cfg
                : int32 scalea_info
 * Output       : None
 * Return Value : int
...
/*
 * Prototype    : wl_scalea_get
 * Description  : get scalea info
 * Input        : struct cfg_struct *cfg
 * Output       : None
 * Return Value : uint16
 * Calls        :
...
/*
 * Prototype    : wl_scaleb_set
 * Description  : set scaleb info
 * Input        : struct cfg_struct *cfg
                : int32 scaleb_info
 * Output       : None
 * Return Value : int
...
/*
 * Prototype    : wl_scaleb_get
 * Description  : get scaleb info
 * Input        : struct cfg_struct *cfg
 * Output       : None
 * Return Value : uint16
 * Calls        :
...
/*
 * Prototype    : wl_mac_addr_set
 * Description  : set mac address info
 * Input        : struct cfg_struct *cfg
                : uint8 *mac
 * Output       : None
 * Return Value : int
...
/*
 * Prototype    : wl_mac_addr_get
 * Description  : get mac address info
 * Input        : struct cfg_struct *cfg
                : uint8 *mac
 * Output       : None
 * Return Value : int
...
/*
 * Prototype    : wl_rf_reg_set
 * Description  : set rf reg info
 * Input        : struct cfg_struct *cfg
                : int32 rf_reg_info
 * Output       : None
 * Return Value : int
...
/*
 * Prototype    : wl_rf_reg_get
 * Description  : get rf reg info
 * Input        : struct cfg_struct *cfg
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_ctrl_network
 * Description  : control network
 * Input        : struct net_device *netdev
                  int32              flag
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : wl_android_set_close5g
 * Description  : close 5g
 * Input        : struct cfg_struct *cfg
                : int32 maddr_value
 * Output       : None
 * Return Value : int
...
/*
 * Prototype    : wl_rx_count_set
 * Description  : clean rx count
 * Input        : struct cfg_struct *cfg
                :
 * Output       : None
 * Return Value : int
...
/*
 * Prototype    : wl_get_rx_info
 * Description  : get rx info
 * Input        : struct cfg_struct *cfg
                :
 * Output       : None
 * Return Value : int
...
/*
 * Prototype    : hwifi_android_ioctl_cmd
 * Description  : deal with android ioctl cmd

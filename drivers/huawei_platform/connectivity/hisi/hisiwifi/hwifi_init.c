 ...
 *
 *
 * File Name     : hwifi_init.c
 * Version       : Initial Draft
 * Author        : zhanlgu z00217036
 * Created       : 2014/4/30
 * Last Modified :
 ...
 */
 ...
 /*
  * Prototype    : hwifi_init_get_log_module_number
  * Description  : get the number of the device log module
 ...
 /*
  * Prototype    : hwifi_init_fill_device_log_msg
  * Description  : fill init device log msg
  * Input        : struct cfg_struct *cfg,struct sk_buff  *skb,const int32 device_log_module_number
  * Output       : None
  * Return Value : int32
  * Calls        :
  * Called By    :
 ...
 /* DTS2014031708932 Hi1101 bug fix zhanglu/z00217036  2014/3/25 begin*/
 /*
  * Prototype    : hwifi_init_get_currttxpow_size
  * Description  : get the size of the device's params
  * Input        : struct cfg_struct *cfg
  * Output       : int32
  * Return Value : int32
  * Calls        :
 ...
 /*
  * Prototype    : hwifi_init_fill_currttxpow_msg
  * Description  : fill the device's currenttxpow msg
  * Input        : struct cfg_struct *cfg
  * Output       : int32
  * Return Value : int32
  * Calls        :
 ...
 /* DTS2014031708932 Hi1101 bug fix zhanglu/z00217036  2014/3/25 end*/
...
static int32 hwifi_init_fill_regdomain_msg(struct cfg_struct *cfg, struct sk_buff *skb)
{
 ...
 /*
  * Prototype    : hwifi_init_hw_params
  * Description  : build Initializing protocol msg for device with wid format and send msg
  * Input        : struct cfg_struct *cfg
  * Output       : None
  * Return Value : int32
  * Calls        :
 ...
 int32 hwifi_init_hw_params(struct cfg_struct *cfg)
 {
     ...
     /* Hi1101 bug fix 2013/11/6:DTS2013102304509 */
     ...
     msg_size += len;
     /* Hi1101 bug fix 2013/11/6:DTS2013102304509 end */
     /* init_msg,WID_11N_ENABLE end*/

     /* init_msg,WID_2040_ENABLE begin*/
     /* DTS2014040210260 Hi1101 bug fix begin */
     ...
     msg_size += len;
     /* DTS2014040210260 Hi1101 bug fix end */

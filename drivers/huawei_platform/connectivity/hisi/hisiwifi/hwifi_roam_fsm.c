...
/*
 * Prototype    : roam_timeout_function
 * Description  :
 * Input        :
...
/*
 * Prototype    : roam_handle_donothing
 * Description  :
 * Input        :
...
/*
 * Prototype    : roam_handle_disconnect
 * Description  :
 * Input        :
...
/*
 * Prototype    : roam_disconn_handle_connect
 * Description  :
 * Input        :
...
void roam_disconn_handle_connect(struct roam_fsm_stru *fsm, void *data)
{
    ...
    /* DTS2014070308446 HI1101 bug fix 2014-6-25 begin */
...
void roam_enter_connect(struct roam_fsm_stru *fsm, void *data)
{
    ...
    switch(fsm->connected_type)
    {
        ...
        case CONNECTED_WAPI:
            ...
            #endif
            /* DTS2014062506177 HI1101 bug fix 2014-6-26 edn */
            break;
        default:
            break;
    }
...
/*
 * Prototype    : roam_connect_handle_trigger
 * Description  :
 * Input        :
...
void roam_connect_handle_trigger(struct roam_fsm_stru *fsm, void *data)
{
    ...
    /* DTS2014082506138 HI1101 bug fix 20140905 begin */
    if(P2P_ON(cfg))
    {
        HWIFI_INFO("p2p mode,ignore roam trigger event.");
        return;
    }
    /* DTS2014082506138 HI1101 bug fix 20140905 end */

#ifdef WLAN_POWER_MANAGEMENT
    if(cfg->hi110x_dev->pm_info->in_suspend)
    {
        HWIFI_INFO("screen off,do not roam to new ap.");
        /* DTS2015032606747  Hi110x bug fix hwx212164 2015/03/28 begin */
        hi110x_set_suspend(cfg->hi110x_dev->pm_info, cfg->hi110x_dev->pm_info->in_suspend);
        /* DTS2015032606747  Hi110x bug fix hwx212164 2015/03/28 end */
        return;
    }
#endif
    /* DTS2014050806333 HI1101 bug fix 2014-6-13 end */
...
/*
 * Prototype    : roam_connect_handle_addkey
 * Description  :
 * Input        :
...
/*
 * Prototype    : roam_scanning_handle_timeout
 * Description  :
 * Input        :
...
/* DTS2014050806333 HI1101 bug fix 2014-6-13 end */
    ...
    /* DTS2014062506177 HI1101 bug fix 2014-6-13 begin */
    roam_start_buffering(roam);
    /* DTS2014062506177 HI1101 bug fix 2014-6-13 end */
...
/*
 * Prototype    : roam_roaming_handle_roamed
 * Description  :
 * Input        :
...
/*
 * Prototype    : roam_roaming_handle_return
 * Description  :
 * Input        :
...
/*
 * Prototype    : roam_roaming_handle_timeout
 * Description  :
 * Input        :
...
/*
 * Prototype    : roam_origin_handle_timeout
 * Description  :
 * Input        :

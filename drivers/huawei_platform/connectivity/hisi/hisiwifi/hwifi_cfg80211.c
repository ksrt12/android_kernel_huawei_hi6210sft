 ...
 *
 *
 * File Name     : hwifi_cfg80211.c
 * Version       : Initial Draft
 * Author        : gongxianglin 00213814
 * Created       : 2012/9/1
 * Last Modified :
 * Description   : cfg80211
 * Function List :
 * History       :
 * 1.Date        : 2012/9/1
 *   Author      : gongxianglin 00213814
...
STATIC struct ieee80211_channel hi110x_5ghz_channels[] = {
    ...
    CHAN5G(161, 0),
    CHAN5G(165, 0),
    /* 4.9G, belong to IEEE80211_BAND_5GHZ class, hkf74032 */
    CHAN4_9G(184, 0),
    CHAN4_9G(188, 0),
    CHAN4_9G(192, 0),
    CHAN4_9G(196, 0),
...
void wl_set_pwrm_late(struct work_struct * work)
{
    ...
    /* DTS2014012203891   Hi110x bug fix 杭天奇 2014/01/23 begin */
    ...
    /* DTS2014012203891   Hi110x bug fix 杭天奇 2014/01/23 end */
}
...
{
    /* stop scan thread before close netdevice: DTS2013010603170 */
                                        ...
                                        struct cfg80211_scan_request *request)
{
    ...
    /* DTS2014010208179 HI1101 bug fix dengwenhua/d00223710 end */
...
/*
 * Prototype    : hwifi_get_cipher_suite
 * Description  : get cipher suite
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
{
    /* DTS2013012307660 : when key_mgmt is NONE, set wep key */
                                            ...
                                            struct cfg80211_connect_params *sme)
{
    ...
    /* DTS2014060504343 hi1101 bug fix x00202101 begin */
    /* solve a scanning problem */
    /* DTS2014031204574 hi1101 bug fix d00223710 begin */
    cfg->conn.status = HWIFI_CONNECTING;
    /* DTS2014031204574 hi1101 bug fix d00223710 end */
    /* DTS2014060504343 hi1101 bug fix x00202101 begin */
    ...
    if (NULL == bss_info)
    {
        ...
        /* DTS2014071802633 hi1101 bug fix d00223710 begin */
        cfg->conn.status = HWIFI_DISCONNECTED;
        /* DTS2014071802633 hi1101 bug fix d00223710 end */
        return -EFAIL;
    }
    /* DTS2013090403988:solve signal icon display exception liuxiaojie wx164577 begin */
    ...
    /* DTS2013012307660 : when key_mgmt is NONE, set crypto type as wep */
...
/* memset cfg->conn.bss 前释放bss结构体成员中动态申的内存 */
    ...
    /*  DTS2013032707492 before get ip, 1101 cant'n enter protocl power saving state */
    ...
    /* DTS2014042101729  Hi110x bug fix x00202101 2014/4/21 begin */
    schedule_delayed_work(&cfg->pwrm_set_work, 120*HZ);
    /* DTS2014042101729  Hi110x bug fix x00202101 2014/4/21 end */
    ...
    /* DTS2014041007097   Hi110x bug fix z00262551 zhouxinfeng end */
#endif
    put_scanned_bss(bss_info);
...
STATIC void fill_station_info(struct stats_struct *stats,  struct station_info  *sinfo)
{
    ...
    if (stats->updated != FALSE)
    {
        ...
        /* DTS2013090403988:solve signal icon display exception liuxiaojie wx164577 begin */
        /* DTS2013111305878 Hi110x bug fix 100225940 2013/11/21 begin*/
        /* DTS2013112714803,DTS2014021207970 Hi110x bug fix l00137985 2014/2/14 begin */
        sinfo->signal = stats->signal;
        if( 0 == sinfo->signal )
        {
            sinfo->signal = cfg->latest_signal;
        }
        /* DTS2013112714803,DTS2014021207970 Hi110x bug fix l00137985 2014/2/14 end */
        /* DTS2013111305878 Hi110x bug fix 100225940 2013/11/21 end*/
        /* DTS2013090403988:solve signal icon display exception liuxiaojie wx164577 end */
...
/*
 * Prototype    : hwifi_cfg80211_set_pmksa
 * Description  : set pmkid
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_cfg80211_add_key
 * Description  : add key
 * Input        : wiphy
                  dev
 *                key_index
...
/*
 * Prototype    : hwifi_cfg80211_get_key
 * Description  : get key
 * Input        : wiphy
                  dev
 *                key_index
...
/*
 * Prototype    : hwifi_cfg80211_set_default_key
...
#endif
#endif
/* DTS2014062506177 HI1101 bug fix 2014-6-26 end */
    return ret;
}

/*
 * Prototype    : hwifi_cfg80211_remove_key
...
/*
 * Prototype    : hwifi_ap_init
 * Description  : init driver when ap mode
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_ap_deinit
 * Description  : init driver when in sta mode
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : itype2name
 * Description  : translate interface type to interface name
 * Input        : enum nl80211_iftype  type
 * Output       : None
...
/*
 * Prototype    : hwifi_cfg80211_change_mode
 * Description  : change current mode(AP/STA)
 * Input        : struct wiphy         *wiphy
                  struct net_device    *ndev
                                            ...
                                            struct vif_params   *params)
{
    ...
    /* DTS2013112201118 Hi1101 bug fix dengwenhua/d00223710 begin */
    ...
    /* DTS2013112201118 Hi1101 bug fix dengwenhua/d00223710 end */
...
/*
 * Prototype    : hwifi_check_beacon_param
 * Description  : check the value of beacon param
 * Input        :
 * Output       :
 * Return Value :
 * Calls        :HWIFI_EID_VENDOR_SPECIFIC
 * Called By    :
 *
 *   History        :
 *   1.Date         : 2012/9/4
...
/*
 * Prototype    : wpa_parse_wpa_ie_rsn
 * Description  : parse rsn ie element
 * Input        : uint8 *ie,
                  int32 ie_len
                  struct hwifi_beacon_param_stru *data
 * Output       : None
 * Return Value : int32
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : wpa_parse_wpa_ie_wpa
 * Description  : parse wpa ie element
 * Input        : uint8 *ie,
                  int32 ie_len
                  struct hwifi_beacon_param_stru *data
 * Output       : None
...
/*
 * Prototype    : hwifi_get_cur_channel
...
/*
 * Prototype    : hwifi_cfg80211_get_channel_info
...
STATIC void hwifi_cfg80211_get_channel_info(struct cfg_struct *cfg, struct cfg80211_chan_def *chan_def, struct hwifi_beacon_param_stru  *beacon_param)
{
   ...
   channel_type = cfg80211_get_chandef_type((const struct cfg80211_chan_def *)chan_def);
    ...
    /* DTS2014080401103 Hi110x bug fix  luolingzhi/l00225940 2014/8/4  begin */
    beacon_param->ht_enabled = cfg->ap_info.ht_enabled;
    /* DTS2014080401103 Hi110x bug fix  luolingzhi/l00225940 2014/8/4  end */
...
/*
 * Prototype    : hwifi_cfg80211_stop_ap
 * Description  : stop ap mode
 * Input        : 
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_cfg80211_start_ap
 * Description  : start ap mode
 * Input        : 
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_cfg80211_change_bss
 * Description  : set BSS information
 * Input        : struct wiphy           *wiphy,
                  struct net_device      *ndev,
...
/*
 * Prototype    : hwifi_cfg80211_set_power_mgmt
 * Description  : cfg80211 operation handler to set power save option.
 * Input        : struct wiphy           *wiphy,
 *                struct net_device      *ndev,
 *                bool                    enabled,
 *                int32                   timeout,
                                                   ...
                                                   int32              timeout)
{
    ...
    /* DTS2013121802197   Hi110x bug fix z00209041 20131218 begin */
    if (g_keepconnect_switch)
    {
    ...
    /* DTS2013121802197   Hi110x bug fix z00209041 20131218 end */
...
/*
 * Prototype    : hwifi_cfg80211_mgmt_tx
 * Description  : send management frame to devcie
 * Input        : struct wiphy *wiphy
                : struct net_device *ndev
...
{
    int32 ret;
    /* DTS2014020702445  Hi110x bug fix l00137985 2014/2/11 begin */
    struct hi110x_device *hi110x_dev;
    /* DTS2014020702445  Hi110x bug fix l00137985 2014/2/11 end */
    if (NULL == cfg)
    {
        HWIFI_WARNING("Invalid NULL cfg!");
        return -EFAIL;
    ...
    /* DTS2014031901660 Hi1101 bug fix d00223710 begin */
    HWIFI_INFO("current p2p flag is %d, set p2p flag:%d to device,", P2P_ON(cfg), flag);
    /* DTS2014031901660 Hi1101 bug fix d00223710 end */
...
/*
 * Prototype    : hwifi_p2p_flag_get
 * Description  :
 * Input        :struct cfg_struct *cfg
 * Output       : None
 * Return Value :p2p flag.TRUE OR FALSE
 * Calls        :
 * Called By    :
 *
 *   History        :
...
/*
 * Prototype    : hwifi_get_cur_mode
 * Description  :
 * Input        :struct cfg_struct *cfg
 * Output       : None
 * Return Value : cur mode
 * Calls        :
 * Called By    :
 *
 *   History        :
...
/*
 * Prototype    : hwifi_cfg80211_set_monitor_channel
 * Description  :
 * Input        : struct wiphy             *wiphy,
                : struct cfg80211_chan_def *chandef,
 * Output       : None
 * Return Value : OK:SUCC,FAIL:-EFAIL
 * Calls        :
 * Called By    :
 *
 *   History        :
 ...
 *
 *   2.Date         : 2014/7/30
 *     Author       : luolingzhi l00225940
 *     Modification : porting from 4.2
 *
...
/*
 * Prototype    : hwifi_set_ht_enabled
 * Description  :
 * Input        : struct cfg_struct *cfg
                : uint8 ht_enabled
 * Output       : None
...
/*
 * Prototype    : hwifi_set_auto_channel
 * Description  : set auto channel flag
 * Input        : struct cfg_struct *cfg
                : int8 auto_channel
 * Output       : None
 * Return Value : OK:SUCC,FAIL:-EFAIL
...
/*
 * Prototype    : hwifi_get_auto_channel
 * Description  : get auto channel flag
 * Input        : struct cfg_struct *cfg
 * Output       : NONE
 * Return Value : auto channel flag
 * Calls        :
 * Called By    :
 *
 *   History        :
...
/*DTS2014041200588  Hi1101 zhanglu/z00217036 begin*/
...
/*DTS2014041200588  Hi1101 zhanglu/z00217036 end*/
...
/* DTS2013101200304  Hi110x bug fix hWX160629 2013/11/07 begin */
#ifdef INI_CONFIG
    //hisi_ini_config_wifi(cfg);
#endif
/* DTS2013101200304  Hi110x bug fix hWX160629 2013/11/07 end */
}
...
/*
 * Prototype    : wl_set_wmm_uapsd
 * Description  : notice device that start to use amsdu
...
/* DTS2013112503428  Hi110x bug fix zhouxinfeng/zwx165479 2013/11/21 begin */
...
/* DTS2013112503428  Hi110x bug fix zhouxinfeng/zwx165479 2013/11/21 end */
...
struct cfg_struct* hwifi_cfg80211_alloc(struct hi110x_device* hi110x_dev, struct device *dev)
{
    ...
    /* DTS2014031708773  Hi1101 bug fix zhanglu/z00217036  2014/3/21 end*/

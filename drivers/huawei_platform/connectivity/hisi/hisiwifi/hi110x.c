...
/* Start of zhanghua 00209041 2013-03-23 B295 缺少版本号 */
int g_wlan_host_version = 295;
/* End of zhanghua 00209041 2013-03-23 B295 缺少版本号 */
 ...
 */
/*
 * Prototype    : hi110x_alloc
 * Description  : alloc and register netdev hcc etc
...
/*
 * Prototype    : hi110x_release
 * Description  : unregister and remove hi110x device
...
/*
 * Prototype    : hi110x_status_ready(struct hi110x_device *hi110x_dev)
 * Description  : test can send data
 * Input        : None
 * Output       : None
 * Return Value : 0 not ready, 1 ready
 * Calls        :
 * Called By    :
 *
 *   History        :

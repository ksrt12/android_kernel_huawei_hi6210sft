...
/* DTS2015070107444  Hi110x bug fix zhanglu/z00217036 2015/7/1 begin */
extern int32 g_dev_err_subcnt;
/* DTS2015070107444  Hi110x bug fix zhanglu/z00217036 2015/7/1 end */
/* wid value */
...
/* DTS2013111305878 Hi110x bug fix 100225940 2013/11/21 begin*/
...
#endif
/* DTS2013113006147  Hi110x bug fix l00137985 2013/12/06 begin*/
...
/* DTS2013113006147  Hi110x bug fix l00137985 2013/12/06 end*/
extern uint32 get_wifi_rssi(void);
/*
 * Prototype    : hwifi_sta_2040_enable_ctrl_set
 * Description  :
...
int32  hwifi_sta_2040_enable_ctrl_set(struct cfg_struct *cfg,uint8 enabled)
{
    ...
    if (SUCC != ret)
    {
       ...
       /* Hi1101 bug fix caowugang/c00221210  2014/7/29 DTS2014072307962 begin*/
       /*dev_kfree_skb_any(skb);*/
       /* Hi1101 bug fix caowugang/c00221210  2014/7/29 DTS2014072307962 end*/
       return -EFAIL;
    }
...
/* Hi1101 bug fix zhanglu/z00217036  2013/12/2 DTS2013110201588 begin*/

/*
 * Prototype    : connect_init_11b_params
 * Description  :
 * Input        : struct cfg_struct *cfg
 * Output       : None
 * Return Value : int32
...
/*
 * Prototype    : disconnect_init_11b_params
 * Description  :
 * Input        : struct cfg_struct *cfg
 * Output       : None
 * Return Value : int32
...
int32 disconnect_init_11b_params(struct cfg_struct *cfg)
{
  ...
  /* Hi1101 bug fix zhanglu/z00217036  2013/12/2 DTS2013110201588 end*/

/*
 * Prototype    : hwifi_channel_index_to_freq
 * Description  :
 * Input        : uint8 index
 * Output       : None
 * Return Value : uint16
...
uint16 hwifi_channel_index_to_freq(uint8 index)
{
    ...
    /* DTS2013111308779  Hi110x bug fix xudayong/x00202101 2013/11/14 begin */
    else if (HWIFI_MAX_CHANNEL_2G == index)
    {
        return (uint16)HWIFI_MAX_FREQ_2G;
    }
    /* DTS2013111308779  Hi110x bug fix xudayong/x00202101 2013/11/14 end */
...
/* DTS2014011406396  Hi110x bug fix zhouxinfeng/z00262551 2014/1/14 end */
...
/* DTS2014011406396  Hi110x bug fix zhouxinfeng/z00262551 2014/1/14 begin */
/*
 * Prototype    : hwifi_send_dfx_wid_char
 * Description  : send dfx wid char command directly,
 * we need't care init flag or INIT CMD, just used for sdt debug.
 * Input        :
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_fill_query_msg_hdr
 * Description  : fill query msg header
 * Input        : None
 * Output       : None
 * Return Value : void
 * Calls        :
 ...
 * Description  : 从输入ie参数中去除P2P IE，拷贝到输出参数ie_out中
 * Input        : ie
 *              : ie_len
 * Output       : ie_out,需要调用者保证 不为空，且有足够空间存储输出IE
 *              : ie_out_len 去除P2P IE后的IE长度
 * Return Value : int32
 * Calls        :
 * Called By    :
 *
...
/*
 * Prototype    : hwifi_start_scan
 * Description  : build scan cmd with wid format and send msg
 * Input        : struct cfg_struct *cfg
                  struct hwifi_scan_param_stru  *cmd
 * Output       : None
 * Return Value : int32
...
int32 hwifi_start_scan(struct cfg_struct *cfg, struct hwifi_scan_param_stru *param)
{
    ...
    /* Hi1101 bug fix 2013/11/9:DTS2013110705337 */
    else
    {
...
/*
 * Prototype    : hwifi_fill_listeninterval
 * Description  : fill listeninterval wid
 * Input        : struct set_teardown_wid *teardown_wid
 * Output       : None
 * Return Value : void
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hwifi_set_listeninterval
 * Description  : set listeninterval wid
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_set_pktfilter
 * Description  : set packet filter wid
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_enable_externTSF
 * Description  : enable extern TSF, then Device can deep sleep when needed
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_set_powermode
 * Description  : set powermode when host change status
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_set_hips_switch
 * Description  : set hips switch
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_fit_cpufreq
 * Description  : fit freqency @ sdio rate
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_shutdown_RF
 * Description  : shutdown RF before shutdown wlan
 * Input        : None
 *   History        :
 *   1.Date         : 2013/8/13
 *     Author       : z00209041
...
/*
 * Prototype    : hwifi_shutdown_powersave
 * Description  : shutdown powersave
...
/*
 * Prototype    : hwifi_set_bt_opt
 * Description  : do some bt optimize when coexist
...
/* DTS2014050806333 HI1101 bug fix 2014-6-13 end */
    ...
    /* p2p added */
    /* DTS2014010801661 Hi110x bug fix hongjiujin/hkf74032 2014/1/20 begin */
    {
        uint16 freq_band;
    ...
    /* DTS2014010801661 Hi110x bug fix hongjiujin/hkf74032 2014/1/20 end */
...
/*
 * Prototype    : hwifi_start_change_mode
 * Description  : change current mode
 * Input        : struct cfg_struct *cfg,
                  struct hwifi_mode_param_stru  *mode_param
 * Output       : None
 * Return Value : SUCC or -EFAIL
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hwifi_set_short_gi
 * Description  : set 11n short gi flag,open or close
 * Input        : struct cfg_struct *cfg,
...
/*
 * Prototype    : hwifi_start_set_beacon
 * Description  : build set_beacon msg with wid format and send msg
 * Input        : struct cfg_struct *cfg,
                  struct hwifi_beacon_param_stru  *beacon_param
 * Output       : None
 * Return Value : SUCC or -EFAIL
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hwifi_start_set_bss
 * Description  : build set_bss msg with wid format and send msg
 * Input        : struct cfg_struct *cfg,
                  struct hwifi_bss_param_stru   *bss_param
 * Output       : None
 * Return Value : SUCC or -EFAIL
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hwifi_start_set_hwmode
 * Description  :
 * Input        : struct cfg_struct *cfg,
...
/*
 * Prototype    : hwifi_start_set_pmksa
 * Description  : build set_pmksa msg with wid format and send msg
 * Input        : None
 * Output       : None
 * Return Value :
 * Calls        :
    ...
    if(stStatInfo.ucTxRateIdx >> 4 == 0x8)/*查找到11n的速率索引*/
    {
        ...
        for(index = 0; index < sizeof(stTxRate)/sizeof(TX_RATE_STRU); index++) /*查表匹配对应的速率值*/
        {
            if( stTxRate[index].ucTxRateIdx == stStatInfo.ucTxRateIdx)
            {
                ...
                /* TS2013082207147 Hi110x bug fix l00137985 2013/11/11 end */
...
/* DTS2013112714803 Hi110x bug fix l00137985 2013/11/29 end */
/* DTS2014010603176 Hi110x bug fix l00137985 2014/1/6 begin */
...
/*
 * Prototype    : smooth_signal_rssi
 * Description  : rssi smooth function
 * Input        : rssi from device
 * Output       : rssi after processing
 * Return Value :
 * Calls        :
 * Called By    :
 *
...
/* DTS2014010603176 Hi110x bug fix l00137985 2014/1/6 end */
/*
...
/* DTS2014070308446 HI1101 bug fix 2014-7-8 begin */
#ifdef __ROAM__
    cfg->roam.roam_fsm.roam_scan_interval_s = calc_scan_interval(&cfg->roam, cfg->latest_signal);
#endif
/* DTS2014070308446 HI1101 bug fix 2014-7-8 end */

    /* DTS2014081301244 Hi1101 bug fix luolingzhi/l00225940 begin */
    ...
    /* DTS2014081301244 Hi1101 bug fix luolingzhi/l00225940 end */
...
/*
 * Prototype    : hwifi_recv_scan_inform
 * Description  : process scanned bss information
 * Input        : struct cfg_struct *cfg
                  uint8 *buf
                  int32 size
 * Output       : None
...
/*
 * Prototype    : hwifi_recv_scan_complete
 * Description  : process scan complete event
 * Input        : struct cfg_struct *cfg
                  uint8 *buf
 * Output       : None
 * Return Value : int32
...
int32 hwifi_recv_conn_res(struct cfg_struct *cfg, uint8 *buf)
{
    ...
    /* DTS2014091006962 Hi110x bug fix d00223710 20140911 begin */
    ...
    /* DTS2014091006962 Hi110x bug fix d00223710 20140911 end */
...
/* DTS2014082006283 Hi110x bug fix hwx212164 2014/09/12 begin */
...
/* DTS2014082006283 Hi110x bug fix hwx212164 2014/09/12 end */
...
int32 hwifi_report_diconnect_res(struct cfg_struct *cfg, uint16 reason)
{
    ...
    /* DTS2015042801288 Hi1101 bug fix hwx212164 2015/04/28 begin */
    ...
    /* DTS2015042801288 Hi1101 bug fix hwx212164 2015/04/28 end */
...
/*
 * Prototype    : hwifi_recv_chang_mode_res
 * Description  : get change mode result
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_recv_config_result
 * Description  : get set param result
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_recv_init_result
 * Description  : get init protocol param result
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_recv_status_ready
 * Description  : get device ready status
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hwifi_cmd_add_key
 * Description  : add key to device
 * Input        : priv
 *                key
 *                seq_num
 * Output       : None
...
/*
 * Prototype    : hwifi_cmd_set_defkey
 * Description  : set default key
 * Input        : priv
 *                key
 *                seq_num
 * Output       : None
...
int32 hwifi_cmd_set_defkey(struct cfg_struct *cfg, struct priv_key_param *key, int8 *mac_addr, uint8 index, bool unicast)
{
    ...
    /* DTS2014050901237 Hi110x bug fix zhanglu/z00217036  2014/5/9 begin */
    ...
    /* DTS2014050901237 Hi110x bug fix zhanglu/z00217036  2014/5/9 end */
    ret = hwifi_send_cmd(cfg, skb);
...
/*
 * Prototype    : hwifi_cmd_remove_key
...
/*
 * Prototype    : hwifi_recv_channel_info
 * Description  : receive channel info
 * Input        : cfg
 *                buf
 *                len
 * Output       : None
...
/* DTS2014041802539    Hi110x bug fix z00217036/zhanglu 2014/4/26 begin */
/*
 * Prototype    : hwifi_recv_upc_info
 * Description  : Recive upc info from device
 * Input        : struct cfg_struct *cfg, int8 *buf, int32 len
 * Output       : None
 * Return Value :
 * Calls        :
...
int32 hwifi_recv_upc_info(struct cfg_struct *cfg, uint8 *buf, int32 len)
{
    ...
    /* DTS2014050901552  Hi110x bug fix zhanglu/z00217036  2014/5/9 begin */
    if(len < 2)
    {
...
/*
 * Prototype    : hwifi_cmd_set_defkey_force
 * Description  : set default key
 * Input        : priv
 *                key
 *                seq_num
...
/* DTS2014010801661 Hi110x bug fix hongjiujin/hkf74032 2014/1/16 end */
    ...
    {
        /* DTS2013111601264  Hi110x bug fix zhouxinfeng/zwx165479 2013/11/21 begin */
        ...
        /* DTS2013111601264  Hi110x bug fix zhouxinfeng/zwx165479 2013/11/21 end */
    }
...
/*
 * Prototype    : hwifi_mgmt_frame_send
 * Description  :
 * Input        :struct cfg_struct *cfg
                :uint32 channel
                :char* buf
...
int32 hwifi_send_p2p_flag(struct cfg_struct *cfg, int32 flag)
{
    ...
    /*added end by lxm for DTS2013102507552*/
...
/*
 * Prototype    : hwifi_cancel_p2p_listen
 * Description  :
 * Input        :struct cfg_struct *cfg
...
/*
 * Prototype    : int32 wl_set_p2p_ie
 * Description  : set probe response ie, assoc response ie and beacon ie
 * Input        : uint8 *beacon_ie
                : uint8 *probe_resp_ie
                : uint8 *assoc_resp_ie
 * Output       : None
 * Return Value : int32
...
/*
 * Prototype    : hwifi_start_set_wiphy
 * Description  :
 * Input        :
 * Output       : None
 * Return Value : int32
...
/*
 * Prototype    : hwifi_set_static_wep_key
 * Description  :
 * Input        :
 * Output       : None
 * Return Value : int32
...
#if 0
/*
 * Prototype    : hwifi_cfg80211_set_power
...
#endif
/*
 * Prototype    : wl_send_channel
 * Description  : send channel to device
 * Input        : struct cfg_struct *cfg,
 *              : uint16 channel
...
int32 hwifi_recv_roam_report(struct cfg_struct *cfg, uint8 *buf)
{
    ...
    switch (roam_substatus)
    {
        ...
        /* DTS2014112703761 Hi1101 bug fix d00223710 20141201 begin */
        case ROAM_SUB_STATUS_TRIGGER_FORCE:
            ...
            ret = hwifi_recv_roam_report_trigger(cfg, buf);
            break;
        /* DTS2014112703761 Hi1101 bug fix d00223710 20141201 end */
...
int32 hwifi_start_roam_scan(struct cfg_struct *cfg, struct roam_scan_cfg_ch_stru *scan_param)
{
    ...
    /* DTS2014061904375 HI1101 bug fix 2014-6-13 begin */
    ...
    /* DTS2014061904375 HI1101 bug fix 2014-6-13 end */
...
int32 hwifi_recv_roam_scan_report(struct cfg_struct *cfg, uint8 *buf)
{
    ...
    if (NULL == candidate_ap)
    {
        ...
        /* DTS2015020702960 Hi1101 bug fix hwx212164 2015/02/07 begin */
        memset(new_ap, 0, sizeof(struct roam_scan_candidate_ap_node));
        /* DTS2015020702960 Hi1101 bug fix hwx212164 2015/02/07 end */
...
/*
 * Prototype    : hwifi_set_dev_roam_report_enabled
 * Description  : enable or disable device report roam trigger event
 * Input        : cfg
                : enabled : enabled or disabled
 *              : (10：是暗屏下发，表示不上报漫游扫描事件)
 *              : (20：表示亮屏下发，表示重新上报漫游扫描事件)
 * Output       : None
 * Return Value : SUCC or failure code
 * Calls        : null
 * Called By    : hi110x_set_suspend
 *
 *   History        :
 *   1.Date         : 2014/11/15
 *     Author       : d00223710
 ...
 * Description  : 计算发送报文失败率，如果过高则触发漫游
 * Input        : struct cfg_struct *cfg

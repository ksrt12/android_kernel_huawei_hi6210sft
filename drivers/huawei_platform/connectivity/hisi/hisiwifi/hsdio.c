...
/* DTS2013110402060  Hi110x bug fix zhouxinfeng/z00262551 2013/11/7 begin */
/*
 * Prototype    : hi110x_sdio_int_stat_dump
 * Description  : dump sdio interrupt & message stat for debug
...
void hi110x_sdio_int_stat_dump(struct hi110x_sdio *hi_sdio, hwifi_union_log* log)
{
    ...
    if(!hi110x_sdio_get_state(&hi_sdio->io_dev))
    {
        ...
        /* DTS2013111203860  Hi110x bug fix zhouxinfeng/z00262551 2013/11/12 begin */
        sdio_release_host(func);
        /* DTS2013111203860  Hi110x bug fix zhouxinfeng/z00262551 2013/11/12 end */
        return ;
    }
...
/*
 * Prototype    : hi110x_heartbeat_timeout_isr
 * Description  : heartbeat time out isr
 * Input        : struct hi110x_sdio *hi_sdio
 * Output       : None
 * Return Value : void
 * Calls        :
...
/*
 * Prototype    : check_pktype_is_beatheart
 * Description  : check it is a beatheart pkt or not
 * Input        : struct hi110x_sdio *hi_sdio, uint8 *buf
 * Output       : None
...
/*
 * Prototype    : hi110x_sdio_rw_buf
 * Description  : read or write buf
 * Input        : struct sdio_func *func, int32 rw, uint32 addr, uint8 *buf, uint32 rw_sz
 * Output       : None
 * Return Value : STATIC int32
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hi110x_sdio_build_sg_from_sklist
 * Description  :
 * Input        : rx_sg the sg list wait to build
 *                next_pkt_sk_list the skb list wait to send
 * Output       :
 *                sg_len the sg list number after build
 *                rw_sz  the total length wait to send
 * Return Value :
 * Calls        :
 * Called By    :
 *
...
/*
 * Prototype    : hi110x_sdio_put_rxbuf
 * Description  :
 * Input        : None
 * Output       : None
 * Return Value :
...
/*
 * Prototype    : hi110x_sdio_check_rx_len
 * Description  : check rx en of sdio
 * Input        : struct hi110x_sdio  *hi_sdio
                uint32 len
 * Output       : None
 * Return Value : int32
...
/* DTS2013120602993  Hi110x bug fix zhouxinfeng/z00262551 2013/12/11 begin */
...
/* DTS2013120602993  Hi110x bug fix zhouxinfeng/z00262551 2013/12/11 end */

/*
 * Prototype    : hi110x_sdio_data_sg_irq(struct hi110x_sdio *hi_sdio)
 * Description  : rx data from sdio
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
int32 hi110x_sdio_data_sg_irq(struct hi110x_sdio *hi_sdio)
{
    ...
    /* DTS2013111601264  Hi110x bug fix zhouxinfeng/z00262551 2013/11/21 begin */
    else
    {
        /*If we have rx data transfer we thought device alive*/
        hisdio_heartbeat_timer_update(hi_sdio, hi_sdio->heartbeat.work_timeout);
    }
    /* DTS2013111601264  Hi110x bug fix zhouxinfeng/z00262551 2013/11/21 end */
...
int32 hi110x_sdio_msg_irq(struct hi110x_sdio *hi_sdio)
{
    ...
    else if (msg & HI110X_MSG_DEVICE_ERROR)
    {
        ...
        /* DTS2013111505974  Hi110x bug fix zhouxinfeng/z00262551 2013/11/15 begin */
        if(sbmsg & 1)
        {
        /* DTS2015070107444  Hi110x bug fix zhanglu/z00217036 2015/7/1 begin */
            g_dev_err_subcnt ++;
        ...
        /* DTS2013111505974  Hi110x bug fix zhouxinfeng/z00262551 2013/11/15 end */
    }
...
/*
 * Prototype    : hi110x_sdio_do_isr
 * Description  : sdio rx data
 * Input        : hi110x_sdio *hi_sdio
 * Output       : None
 * Return Value : int
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hi110x_sdio_rx_skb_pool_list_clear
 * Description  : clear rx dispose data list
 * Input        : hi_sdio
 * Output       : None
 * Return Value : void
 * Calls        :
...
/*
 * Prototype    : hi110x_sdio_dispose_data
 * Description  : dispose data
 * Input        : hi_sdio
 * Output       : None
 * Return Value : void
 * Calls        :
...
/*
 * Prototype    : hi110x_sdio_dispose_thread
 * Description  : sdio dispose rx data function
 * Input        : adapter   hi110x_sdio handler
 * Output       :
...
/*
 * Prototype    : hi110x_sdio_isr_work
 * Description  : sdio isr work to process rx frame
...
/*
 * Prototype    : hi110x_sdio_wakeup_work
 * Description  : sdio wakeup function
 * Input        : adapter   hi110x_sdio handler
 * Output       :
 * Return Value : void
 * Calls        :
...
/*
 * Prototype    : hi110x_wait_sleepmsg
 * Description  : wait for device allow or forbid msg, the hi110x_sdio_msg_irq
 *                function must be blocked when call this function,
 *                lock by hcc_trans_lock
 * Input        : struct hi110x_sdio  *hi_sdio
 * Output       :
 * Return Value : void
 * Calls        :
 ...
 *   1.Date         : 2013/11/6
 *     Author       : z00262551
 *     Modification : Created function For
 *
 */
/* DTS2013110402060  Hi110x bug fix zhouxinfeng/z00262551 2013/11/7 begin */
...
/* DTS2013110402060  Hi110x bug fix zhouxinfeng/z00262551 2013/11/7 end */
/*
 * Prototype    : hi110x_sdio_sleep_work
 * Description  : sdio wakeup function
 * Input        : adapter   hi110x_sdio handler
 * Output       :
 * Return Value : void
...
/*
 * Prototype    : hi110x_gpio_rxdata_thread
...
/*
 * Prototype    : hi110x_gpio_intr_enable
 * Description  : set gpio interrupt
 * Input        :
 * Output       : None
 * Return Value : void
 * Calls        :
...
/*
 * Prototype    : hi110x_register_gpio_intr
...
/*
 * Prototype    : hi110x_unregister_gpio_intr
 * Description  : initialize sdio pm interface
 * Input        :
 * Output       : None
 * Return Value : void
...
/*
 * Prototype    : hi110x_sdio_interrupt_register
...
/*
 * Prototype    : hi110x_sdio_interrupt_unregister
...
/*
 * Prototype    : hi110x_sdio_dev_init
...
/*
 * Prototype    : hi110x_sdio_get_state
...
/*
 * Prototype    : hi110x_sdio_set_state
 * Description  : set the sdio bus state
 * Input        : struct iodevice *io_dev, uint8 state: TRUE/FALSE
 * Output       : None
 * Return Value : void
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hi110x_sdio_rx_transfer_info_reset(struct hi110x_sdio *hi_sdio)
 * Description  : reset next transfer pkg len and list!.
 * Input        : struct iodevice *io_dev, uint8 locked TRANS_LOCK/TRANS_UNLOCK
 * Output       : None
 * Return Value : void
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hi110x_bus_enable
 * Description  : enable sdio function
 * Input        : adapter   hi110x_sdio handler
 * Output       : None
 * Return Value : err or succ
 * Calls        :
 ...
 *   History        :
 *   1.Date         : 2012/5/17
 *   2.Date         : 2013/6/26 Modify by z00262551
 *     Author       : c00189311
 *     Modification : Created function
 *
 */
...
/* DTS2013120503722  Hi110x bug fix z00262551 zhouxinfeng  2014/1/24 begin */
/*
 * Prototype    : hwifi_send_shutdown_msg
 * Description  : notice device shutdown msg
 * Input        : None
 * Output       : None
 * Return Value :
 * Calls        :
...
/*
 * Prototype    : hwifi_notice_device_shutdown
 * Description  : notice device to do shudown clear work
 * Input        : adapter   hi110x_sdio handler
 * Output       : None
 * Return Value : void
 * Calls        :
...
/* DTS2013120503722  Hi110x bug fix z00262551 zhouxinfeng  2014/1/24 end */

/*
 * Prototype    : hi110x_bus_disable
 * Description  : disable sdio function
 * Input        : adapter   hi110x_sdio handler
 * Output       : None
 * Return Value : err or succ
 * Calls        :
...
/*
 * Prototype    : hi110x_bus_suspend
 * Description  : suspend sdio bus
 * Input        : adapter   hi110x_sdio handler
 * Output       : None
 * Return Value : err or succ
 * Calls        :
...
/*
 * Prototype    : hi110x_bus_transfer
 * Description  : transfer data from host to device
 * Input        : adapter   hi110x_sdio handler
 *                buf       data buffer handler
 *                len       data len
 * Output       : None
 * Return Value : err or succ
 * Calls        :
...
/*
 * Prototype    : hi110x_bus_reset_flowctrl
 * Description  : reset device flower
 * Input        : struct iodevice* iodev
 * Output       : None
 * Return Value : int32
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hi110x_bus_interrupt_pending
 * Description  : in interrupt
 * Input        : struct iodevice *io_dev
 * Output       : None
 * Return Value : int32
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hi110x_bus_get_max_transfer_size
 * Description  : get max size per transfer
 * Input        : struct iodevice * iodevice
 * Output       : None
 * Return Value : uint32
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hi110x_sdio_alloc(sdio_func *func)
 * Description  : alloc and init hi110x_sdio
 * Input        : None
 * Output       : None
 * Return Value : struct hi110x_sdio*
 * Calls        :
 * Called By    :
 *
 *   History        :
...
struct hi110x_sdio* hi110x_sdio_alloc(struct sdio_func *func)
{
    ...
    /* DTS2013112501668   Hi110x bug fix zhouxinfeng/z00262551 2013/11/27 begin */
    exception_enable = hwifi_get_param_int(HISI_CONFIG_WIFI_EXCEPTION_ENABLE);
    /* DTS2013112501668   Hi110x bug fix zhouxinfeng/z00262551 2013/11/27 end */
...
/*
 * Prototype    : hi110x_sdio_rw_sg
 * Description  : sdio scatter data transfer
 * Input        : hi_sdio   hi110x_sdio handler
 *                rw       SDIO_READ or SDIO_WRITE
 *                addr     sdio access address
                  sg        scatterlist wait to transfer
                  sg_len    sg item number
 * Output       : None
 * Return Value : err or succ
 * Calls        :
 * Called By    :
                        ...
                        uint32 sg_len, uint32 rw_sz)
{
    ...
    if(unlikely(ret))
    {
        ...
        HWIFI_ERROR("Hsdio %s Failed, We export a exception.[sg_len:%u][rw_sz:%u]", write ?"Write":"Read", sg_len, rw_sz);
        hwifi_exception_submit(hi_sdio->hi110x_dev->hcc);
...
/*
 * Prototype    : hi110x_bus_transfer_sg
 * Description  : transfer scatter data from host to device
 * Input        : io_dev   bus device handler
 *                buf       data buffer handler
 *                len       data len
 * Output       : None
 * Return Value : err or succ
...
STATIC int32  hi110x_init_global_params(void)
{
   ...
   /* DTS2013101200304  Hi110x bug fix hWX160629 2013/11/21 begin */
    ...
    /* DTS2013120502748   Hi110x bug fix 杭天奇/hwx160629 2013/12/10 begin */
    countrycode_change_by_ie_enabled = hwifi_get_param_int(HISI_CONFIG_WIFI_COUNTRYCODE_CHANGE_BY_IE);
    /* DTS2013120502748   Hi110x bug fix 杭天奇/hwx160629 2013/12/10 end */
...
#ifdef WLAN_POWER_MANAGEMENT
    /* DTS2015031001875 Hi110x bug fix hwx212164 2015/03/10 begin */
    wlan_power_off();
    /* DTS2015031001875 Hi110x bug fix hwx212164 2015/03/10 end */
#endif
    hsdio_io_cfg_exit();
failed_io_cfg_init:
    userctrl_exit();

...
/* DTS2014010900774  Hi110x bug fix zhouxinfeng/z00262551 2014/01/09 begin */
...
/* DTS2014010900774  Hi110x bug fix zhouxinfeng/z00262551 2014/01/09 end */
                                        ...
                                        bool reduce,int i)
{
    ...
    while(1)
    {
        ...
        /* DTS2013121204358  Hi110x bug fix zhouxinfeng/z00262551 2013/12/12 begin */
        ...
        /* DTS2013121204358  Hi110x bug fix zhouxinfeng/z00262551 2013/12/12 end*/
    }
}
...
/*DTS2013122007483   Hi110x bug fix zhouxinfeng/z00262551 2014/1/3 end */
 ...
 /*
 * Prototype    : hcc_queues_flow_ctrl_handle
 * Description  : check whether should we wake or stop the kernel net queue
 * Input        : struct hcc_handler* hcc,hcc_queue_type type,
                  hcc_chan_type dir,bool wake_net_flow
                  TRUE:wake the queue if lower than the lower water-line
                  FALSE:stop the queue if more than the higher water-line
 * Output       : None
 * Return Value : None
 * Calls        :
 * Called By    :
...
void hcc_trans_dyn_pri_control(struct hcc_handler* hcc, int enable)
{
 ...
 /*
 * Prototype    : hcc_sched_transfer
 * Description  : sched the hcc channel
...
/* DTS2013121806332  Hi110x bug fix zhouxinfeng/z00262551 2013/12/18 end */

 /*
 * Prototype    : hcc_get_queue_str
 * Description  : get string
 * Input        : hcc_queue_type q_type
 * Output       : None
 * Return Value : char*
 * Calls        :
 * Called By    :
...
char* hcc_get_dir_str(hcc_chan_type dir)
{
 ...
 /*
 * Prototype    : hcc_tx_chan_is_vaild
 * Description  : check the tx channel is vaild TRUE/FALSE
 * Input        : struct hcc_handler* hcc
 * Output       : None
 * Return Value : int
 * Calls        :
...
#endif
{
 ...
 /*
 * Prototype    : hcc_netif_txflowcontrol
 * Description  : send packet flow control
 * Input        : struct hcc_handler* hcc
                  uint32     state
 * Output       : None
 * Return Value : None
...
/*
 * Prototype    : hcc_tx_start_queue
 * Description  : enable tx queue flag
 * Input        : struct hcc_handler* hcc, TRANS_LOCK/TRANS_UNLOCK
 * Output       : None
 * Return Value : None
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hcc_tx_stop_queue
 * Description  : disable tx queue flag
 * Input        : struct hcc_handler* hcc, uint8 locked TRANS_LOCK/TRANS_UNLOCK
 * Output       : None
 * Return Value : None
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hcc_tx_wake_queue
 * Description  : enable tx queue flag and wake up tx thread
 * Input        : struct hcc_handler* hcc, locked: TRANS_LOCK/TRANS_UNLOCK
 * Output       : None
 * Return Value : None
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hcc_set_tx_queue_status
 * Description  : set the tx queue suspend status.
 * Input        : struct hcc_handler* hcc
 * Output       : None
 * Return Value : None
 * Calls        :
...
/*
 * Prototype    : hcc_get_tx_queue_status
 * Description  : set the tx queue suspend status.
 * Input        : struct hcc_handler* hcc
 * Output       : None
 * Return Value : None
...
{
    /* DTS2013111803333  Hi110x bug fix zhouxinfeng/z00262551 2013/11/20 begin */
    ...
    /* DTS2013111803333  Hi110x bug fix zhouxinfeng/z00262551 2013/11/20 end */
}
...
void hcc_tx_queue_all_reset(struct hcc_handler* hcc, uint8 locked)
{
 ...
 /*
 * Prototype    : hcc_transfer_reset
 * Description  : reset hcc layer
 * Input        : struct hcc_handler* hcc
                  uint8 flag  : TRUE:reset hcc layer, FALSE: restore hcc layer!
 * Output       : None
 * Return Value : None
 * Calls        :
 * Called By    :
...
/*DTS2013122804682   Hi110x bug fix zhouxinfeng/z00262551 2014/1/2 begin */
/*
 * Prototype    : hcc_queues_reset
 * Description  : reset hcc rx/tx queues
 * Input        : struct hcc_handler* hcc
 * Output       : None
 * Return Value : None
 * Calls        :
...
/* Prototype    : check_txqueue_status
 * Description  : check txqueue, loop up queue status
 * Input        : struct hcc_handler* hcc
 * Output       : None
 * Return Value : uint32
 * Calls        :
...
/*
 * Prototype    : hcc_build_header
 * Description  : build hcc header
 * Input        : (struct hcc_handler *hcc, uint8 main_type, uint8 sub_type, struct sk_buff *skb)
 * Output       : None
 * Return Value :  int32
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hcc_skb_tx_queue_tail
 * Description  : put skb to tx queues tail
 * Input        : None
 * Output       : None
...
/*
 * Prototype    : hcc_skb_rx_queue_tail
 * Description  : put skb to rx queues tail
 * Input        : None
 * Output       : None
 * Return Value : STATIC void
 * Calls        :
...
/*
 * Prototype    : hcc_dispose_pkts
 * Description  : dispose pkts to network layer
 * Input        : None
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : expand_assemble_info_space
 * Description  : rt
...
/*
 * Prototype    : hcc_rx_data_separate_into_queues
 * Description  :  separate rx skb list into rx_queues.
 * Input        :
                struct hcc_handler* hcc, struct sk_buff_head *pkt_sk_list_head
 * Output       : None
 * Return Value : None
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : align skb->data and skb->len
 * Description  : rt
 * Input        :
                struct sk_buff *skb -- this skb must expand the assemble info
 * Output       : None
 * Return Value : SUCC or err
 * Calls        :
 * Called By    :
 *
 *   History        :
...
/*
 * Prototype    : make_assemble_info
 * Description  : rt
 * Input        : struct hcc_handler *hcc
                struct sk_buff *skb
                uint32 assemble_info_cnt
                can_expand: when send assemble packet,
                        because length has been to devie,
                        so can't been expand
 * Output       : None
 * Return Value : void
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : send_single_packet  needn't 8 bytes align!!
 * Description  : send pkt
 * Input        : struct sk_buff *skb
                uint32 remain_pkt_cnt
 * Output       : None
 * Return Value : int32
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hcc_rx_pkt_list_verfiy
 * Description  :  get next assem infomation include transfer length and build next skb list
 * Input        : hi_sdio
 *
 * Output       :
 *
...
/*
 * Prototype    : hcc_get_nextpkt_skb_info
 * Description  :  get next assem infomation include transfer length and build next skb list
 * Input        : hi_sdio
 *
 * Output       :
...
/*
 * Prototype    : hcc_send_tx_queue_single
 * Description  : send the tx data single, this send is not under flow control!
 * Input        : struct hcc_handler *hcc
 * Output       : None
 * Return Value : int the remain size of the queue to be sent
 * Calls        :
 * Called By    :
 *
 *   History        :
...
/*
 * Prototype    : hcc_send_tx_queue_assemble
 * Description  : send the tx data single, this send is under flow control!
 * Input        : struct hcc_handler *hcc
 * Output       : None
 * Return Value : int the remain size of the queue to be sent
 * Calls        :
...
/*
 * Prototype    : hcc_send_rx_queue
 * Description  : send the special sdio queue to kernel net layer
 * Input        : struct hi110x_sdio *hi_sdio
 * Output       : None
 * Return Value : 1:have deal some queues 0:no data to be dealed
 * Calls        :
 * Called By    :
 *
 *   History        :
...
/*
 * Prototype    : hcc_send_single_data_packet
 * Description  : send one packet
 * Input        : struct hcc_handler* hcc, struct sk_buff_head *head the tx queue wait to send
 * Output       : None
 * Return Value : int32
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : hcc_send_assemble_data_packet
 * Description  : send assemble packet
 * Input        : struct hcc_handler *hcc
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hcc_send_assemble_reset
 * Description  : send hcc ctrl frame
 * Input        : struct hcc_handler *hcc
 * Output       : None
 * Return Value : int32
 * Calls        :
...
#if 0
/*
 * Prototype    : hcc_send_hi_ctrl_packets
 * Description  : send all ctrl data
 * Input        : struct hcc_handler* hcc
 * Output       : None
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : hcc_transfer_process
 * Description  : deal with skb tx and hcc_rx
 * Input        : struct hcc_handler *hcc
 * Output       : None
 * Return Value : 1: have data to process 0: empty loop
 * Calls        :
 * Called By    :
 *
 *   History        :
...
/*
 * Prototype    : hcc_trans_thread
 * Description  : hcc rx/tx process thread
 * Input        : data
 * Output       : None
 * Return Value : SUCC
 * Calls        :
...
/*
 * Prototype    : hwifi_rx_cb_default
 * Description  : provide call back register interface
 * Input        : uint8 main_type,
 *                uint8 sub_type,
 *                struct sk_buff *skb
 *                void *context
 * Output       : None
...
/*
 * Prototype    : hcc_rx_unregister
 * Description  : unregister rx cb
 * Input        : int8 mtype
                hcc_handler *hcc
 * Output       : None
 * Return Value : int32
...
/* DTS2014020701562  Hi110x bug fix zhouxinfeng/z00262551 2014/2/27 begin */
/*
 * Prototype    : hcc_net_stream_connected
 * Description  : check the stream_t whether connected
 * Input        : struct hcc_handler    *hcc, hwifi_net_stream_type stream_t
 *
 * Output       : None
...
/*
 * Prototype    : hcc_net_streams_connected
 * Description  : check the streams whether connected, once one stream connected return TRUE;
 * Input        : struct hcc_handler    *hcc, hwifi_net_stream_type stream_t
 *
 * Output       : None
...
/*
 * Prototype    : hcc_net_stream_try_connect, just do stream count, do not enqueue.
 * Description  :
 * Input        : struct hcc_handler    *hcc, hwifi_net_stream_type stream_t
 *
 * Output       : None
...
/*
 * Prototype    : hwifi_rx_cb_init
 * Description  : provide call back register interface
 * Input        : struct hi110x_device  handle
 *
 * Output       : None
 * Return Value : void
 * Calls        :

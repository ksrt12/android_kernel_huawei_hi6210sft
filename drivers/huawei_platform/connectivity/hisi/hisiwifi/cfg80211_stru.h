 ...
 ******************************************************************************
  文 件 名   : cfg80211_stru.h
  版 本 号   : 初稿
  作    者   : l00225940
  生成日期   : 2012年8月22日
  最近修改   :
  功能描述   : cfg80211_stru.c 的头文件
  函数列表   :
  修改历史   :
  1.日    期   : 2012年8月22日
    作    者   : l00225940
  ...
  2.日    期   : 2012年8月23日
    作    者   : l00225940
    修改内容   : 添加WID、封装基本数据类型；添加AP上报消息；修正STA上报消息；
...
/* DTS2014090208936 HI1101 bug fix d00223710 20140904 begin */
#ifdef MAC_802_11W
#define NETLINK_PMF (NETLINK_HISI_WIFI_PMF)   /* 此数值不能和linux已有定义冲突 */
#endif
/* DTS2014090208936 HI1101 bug fix d00223710 20140904 end */
...
typedef enum {
   ...
   /* DTS2013111504672  Hi110x bug fix hWX160629 2013/11/15 begin */
   WID_CURRENT_TX_POW                  = 0x00D7,
   /* DTS2013111504672  Hi110x bug fix hWX160629 2013/11/15 end */
    /* arp offload */

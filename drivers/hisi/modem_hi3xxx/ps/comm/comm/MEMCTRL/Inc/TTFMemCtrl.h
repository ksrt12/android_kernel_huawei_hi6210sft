...
#define TTF_MEM_SET_SUPPORT_WCDMA(IsSupportWcdma) \
    (g_stTtfMemDynamicCtrlEntity.ucSupportWcdma = (IsSupportWcdma))

#define TTF_MEM_GET_SUPPORT_WCDMA() \
    (g_stTtfMemDynamicCtrlEntity.ucSupportWcdma)
...
/*****************************************************************************
 枚举名    : TTF_MEMCTRL_SUPPORT_WCDMA_ENUM_ENUM8
 协议表格  :
 ASN.1描述 :
 枚举说明  : 回调函数表示
*****************************************************************************/
enum TTF_MEMCTRL_SUPPORT_WCDMA_ENUM
{
    TTF_MEMCTRL_SUPPORT_WCDMA_NO    = 0,                 /* 支持WCDMA */
    TTF_MEMCTRL_SUPPORT_WCDMA_YES,                       /* 不支持WCDMA */

    TTF_MEMCTRL_SUPPORT_WCDMA_BUTT
};
typedef VOS_UINT8 TTF_MEMCTRL_SUPPORT_WCDMA_ENUM_ENUM8;

 ...
 */
    ...
    else if(FTM_TSELRF_WIFI == ulPath)
    {
        ...
        if(ulRst == ERR_MSP_SUCCESS)
        {
            ...
            /* DTS2012060804812 c64416 start in 2012-06-11 for ^TSELRF */
            ...
            /* DTS2012060804812 c64416 end in 2012-06-11 for ^TSELRF */

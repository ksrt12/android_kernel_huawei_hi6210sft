...
/*****************************************************************************
 函 数 名  : OmAcpuSendIndSucShow
 功能描述  : 打印数据从UE侧发往PC侧时IND通道正常处理的数据
 输入参数  :
 输出参数  :
 返 回 值  :
 调用函数  :
...
/*****************************************************************************
 函 数 名  : OmAcpuSendCnfSucShow
 功能描述  : 打印数据从UE侧发往PC侧时CNF通道正常处理的数据
 输入参数  :
 输出参数  :
 返 回 值  :
 调用函数  :

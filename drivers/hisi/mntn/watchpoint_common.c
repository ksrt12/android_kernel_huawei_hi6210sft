...
//            mlog_n("<%d> callback   is 0x%pK", i, wp->watchpoint_callback);
//            mlog_n("<%d> user_param is 0x%pK", i, wp->user_param);
            snprintf(kbuf, WP_DBG_SIZE_PAGE, "%s<%d> callback   is 0x%pK\n", kbuf, i, wp->watchpoint_callback);
            snprintf(kbuf, WP_DBG_SIZE_PAGE, "%s<%d> user_param is 0x%pK\n", kbuf, i, wp->user_param);
        }
    }

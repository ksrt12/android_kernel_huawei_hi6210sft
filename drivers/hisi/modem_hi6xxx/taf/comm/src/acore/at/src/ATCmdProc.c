...
/* Added by A00165503 for IPV6, 2011-05-30, end */
    ...
    /* Modified by l00171473 for DTS2012122200186, 2012-12-22, begin */
    {AT_STRING_CEREG,(TAF_UINT8*)"+CEREG: "},
    /* Modified by l00171473 for DTS2012122200186, 2012-12-22, end */
#endif
...
)
{
    ...
    /* Added by f00179208 for DTS2013111204929, 2013-11-12, Begin   */
    /* 如果参数是超过61个返回失败 */
    if (ulParaCnt > 61)
    {
        PS_MEM_FREE(WUEPS_PID_AT, pucDataPara);
    ...
    /* Added by f00179208 for DTS2013111204929, 2013-11-12, End   */
...
VOS_VOID At_SetMode(VOS_UINT8 ucIndex, AT_MODE_TYPE Mode, VOS_UINT8 ucSubMode)
{
    ...
    {
        /*Modified by w00181244 for AT_Project, 2011-11-1, Begin*/
        g_stParseContext[ucIndex].ucMode = ucSubMode;
        /*Modified by w00181244 for AT_Project, 2011-11-1, End*/
    }
    /* Added by A00165503 for UART-MODEM Project, 2013-09-23, Begin */
...
)
{
    ...
    switch(gastAtClientTab[ucIndex].CmdCurrentOpt)
    {
        ...
        /*Modified by f62575 for DTS2011041200554, 2011-04-19, begin */
        ...
        /* c00172979 added start 装备AT命令融合 */
        ...
        /*Modified by f62575 for DTS2011041200554, 2011-04-19, end */
        ...
        /* Added by l00171473 for V7R1C50_At_Abort, 2012-9-19, end */
        /* Added by f62575 for DTS2012122700666, 2012-12-28, begin */
        case AT_CMD_CMGS_TEXT_SET:
        case AT_CMD_CMGS_PDU_SET:
        case AT_CMD_CMGC_TEXT_SET:
        case AT_CMD_CMGC_PDU_SET:
        ...
        case AT_CMD_CMST_SET:
            ...
            break;
        /* Added by f62575 for DTS2012122700666, 2012-12-28, end   */
...
)
{
    ...
    /* Modified by s00217060 for VOLTE SWITCH, 2015-3-4, begin */
    ...
    /* Modified by s00217060 for VOLTE SWITCH, 2015-3-4, end */
...
/* Added by l00167671 for PC project, 2012-01-20, begin */
/* Added by z00234330 for PC project, 2014-01-07, begin */
...
/*lint +e960 修改人:l60609;原因:64bit*/
/* Added by z00234330 for PC project, 2014-01-07, end */
/* Added by l00167671 for PC project, 2012-01-20, end */
...
{
    /* Modified by f00179208 for At Project, 2011-10-22, Begin */
    switch(enCallType)
    /* Modified by f00179208 for At Project, 2011-10-22, End */
    {

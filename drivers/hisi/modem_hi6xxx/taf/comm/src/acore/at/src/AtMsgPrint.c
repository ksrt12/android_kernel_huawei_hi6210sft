...
)
{
    ...
    */
    ...
    /* Modified by l00167671 for DTS2012121110930, 2012-12-11, begin */
    /* Year */
...
)
{
    ...
    usLength   += (TAF_UINT16)At_sprintf(AT_CMD_MAX_LEN,
                                       ...
                                       "%d",
                                       ucAddrType);
    /* Modified by L60609 for DTS2012070200072, 2011-12-06,  End  */
...
)
{
    ...
    /* Added by Y00213812 for DTS2012120303885, 2012/12/03, begin */
    else if (('A' == cAsciiCode)
          || ('B' == cAsciiCode)
          || ('C' == cAsciiCode))
    {
    ...
    /* Added by Y00213812 for DTS2012120303885, 2012/12/03, end */
    else
    {
        /* Modified by s00217060 for VoLTE_PhaseIII  项目, 2013-12-24, begin */

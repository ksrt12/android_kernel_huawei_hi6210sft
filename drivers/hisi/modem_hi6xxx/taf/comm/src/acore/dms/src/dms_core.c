...
/* Added by z00301431 for DTS2015012909889, 2015-2-15 begin */
#if (VOS_OS_VER == VOS_LINUX)
#include <linux/wakelock.h>
#endif
/* Added by z00301431 for DTS2015012909889, 2015-2-15 end */
...
/* Added by j00174725 for Get Slice File, 2015-1-04, Begin */
#if (VOS_OS_VER == VOS_WIN32)
...
#endif
/* Added by j00174725 for Get Slice File, 2015-1-04, End */
...
VOS_VOID DMS_Init(VOS_VOID)
{
    ...
    /* Del by j00174725 for DTS2014082200355, 2013-10-25, begin */
    /* Del by j00174725 for DTS2014082200355, 2013-10-25, End */
...
VOS_VOID DMS_UsbDisableCB(VOS_VOID)
{
    ...
    /* modifyed by z60575 for DTS2013090208292, 2013-09-03 begin */
    /* nv值为1表示有at sever，非1表示无at sever，无at sever关闭pcui和ctrl口 */
    if (VOS_TRUE == g_stDmsMainInfo.bPortOpenFlg)
    /* modifyed by z60575 for DTS2013090208292, 2013-09-03 end */
    {
        /* 关闭PCUI通道 */
...
VOS_VOID DMS_UsbEnableCB(VOS_VOID)
{
    ...
    /* Added by z60575 for DTS2013090208292, 2013-09-03 end */
...
VOS_INT __init DMS_InitPorCfgFile(VOS_VOID)
{
    ...
    /* Add by j00174725 for DTS2014082200355, 2013-10-25, begin */
    g_stDmsMainInfo.bPortCfgFlg     = VOS_FALSE;
    g_stDmsMainInfo.bPortOpenFlg    = VOS_FALSE;
    g_stDmsMainInfo.ulPortCfgValue  = DMS_TEST_MODE;
    /* Add by j00174725 for DTS2014082200355, 2013-10-25, End */
...
)
{
    ...
    /* Modify for DTS2015070108361, 2015-1-23 begin */
    memcpy(pstPlayload->aucData, pucData, ulLength);
    /* Modify for DTS2015070108361, 2015-1-23 end */
...
)
{
    ...
    mdrv_timer_get_accuracy_timestamp(&ulHigh32bitValue, &ulLow32bitValue);

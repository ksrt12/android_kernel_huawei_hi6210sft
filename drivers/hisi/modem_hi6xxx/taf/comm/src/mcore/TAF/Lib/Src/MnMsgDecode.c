...
/* Added by f00317170 for DTS2015092902663, 2015-10-05, begin */
...
/* Added by f00317170 for DTS2015092902663, 2015-10-05, end */
...
)
{
    ...
    if (VOS_TRUE == bRpAddr)
    {
        ...
        /* Modified by f62575 for DTS2012070200072, 2012-07-03,  Begin*/
        if (ucBcdLen > MN_MSG_MAX_BCD_NUM_LEN)
        /* Modified by f62575 for DTS2012070200072, 2011-12-06,  End  */
        {
    ...
    ulPos++;
    /* Modified by f62575 for DTS2012062202118, 2011-06-26, begin */
    if ((VOS_TRUE != bRpAddr)
     && (MN_MSG_TON_ALPHANUMERIC == pstAsciiAddr->enNumType))
    /* Modified by f62575 for DTS2012062202118, 2011-06-26, end   */
    {
...
)
{
    ...
    /* add by j00174725 for Fortify, 2013-7-25, begin */
    ucIeiLen += 2;
    /* add by j00174725 for Fortify, 2013-7-25, end */
...
)
{
    ...
    /* Modified by s00217060 for DTS2015120405133, 2015-12-10, begin */
    if (pstUserDefSound->ucSizeofSound > MN_MSG_UDH_MAX_SOUND_SIZE)
    {
        pstUserDefSound->ucSizeofSound  = MN_MSG_UDH_MAX_SOUND_SIZE;
    }
    /* Modified by s00217060 for DTS2015120405133, 2015-12-10, end */
...
)
{
    ...
    /* Added by s00217060 for DTS2015120405133, 2015-12-10, begin */
    if (pstEo->usDataLen > MN_MSG_MAX_UDH_LONG_EO_DATA_LEN)
    {
        pstEo->usDataLen = MN_MSG_MAX_UDH_LONG_EO_DATA_LEN;
    }
    /* Added by s00217060 for DTS2015120405133, 2015-12-10, end */
...
)
{
    ...
    /*lint +e961*/
    /* Modified by f62575 for DTS2013041704040, 2013-04-17, begin */
    ...
    /* Modified by f62575 for DTS2013041704040, 2013-04-17, end   */

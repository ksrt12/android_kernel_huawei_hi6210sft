...
)
{
    ...
    /* Modified by s00217060 for DTS2014040203906, 2014-05-06, begin */
    /* 如果在BS表中没有找到对应的项，仍然返回成功做call control检查 */
    *pulBSLength    = 0;
    *pcOutMmiStr    = VOS_NULL_PTR;

    return VOS_TRUE;
    /* Modified by s00217060 for DTS2014040203906, 2014-05-06, end */
}
...
)
{
    ...
    /* Modified by j00174725 for Coverity, 2013-7-25, begin */
    ...
    /* Modified by j00174725 for Coverity, 2013-7-25, End */

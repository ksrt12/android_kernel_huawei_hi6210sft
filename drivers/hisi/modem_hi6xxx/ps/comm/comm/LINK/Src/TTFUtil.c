...
VOS_UINT32 TTF_CopyLink_DL_Execute(VOS_UINT32 ulPid, TTF_COPYLINK_DL_STRU *pstTtfCpyLink)
{
        ...
        ulCopyNodeLoop++)
    {
        ...
        mdrv_memcpy(pstCopyLinkNode->pucDstData,
    ...
    VOS_UINT8 *pucSrcData, VOS_UINT16 usDataLen, VOS_UINT16 usModLen)
{
    ...
    {
        mdrv_memcpy(pucDst, pucSrcData, usDataLen);
    }
    else
    {
        mdrv_memcpy(pucDst, pucSrcData, usBufLeftLen);
        mdrv_memcpy((VOS_UINT8 *)(VOS_UINT_PTR)ulDstRingBufBaseAddr, (VOS_UINT8 *)(VOS_UINT_PTR)pucSrcData + usBufLeftLen,
...
)
{
    ...
    if (usDataLen > usLeft)
    {
        ...
        mdrv_memcpy( pucDstData, pucSrc, usLeft);
        mdrv_memcpy((VOS_UINT8 *)( pucDstData + usLeft),
                      (VOS_UINT8 *)(VOS_UINT_PTR)ulSrcRingBufBaseAddr,
                      (usDataLen - usLeft));
    }
    else
    {
        mdrv_memcpy(pucDstData,pucSrc,usDataLen);
    }

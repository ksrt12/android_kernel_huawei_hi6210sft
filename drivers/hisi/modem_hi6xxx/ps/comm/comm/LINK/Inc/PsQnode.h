...
typedef struct
{
    VOS_UINT32                      ulAllocTotalCnt;
    VOS_UINT32                      ulAllocFailCnt;         /* 申请Qnode失败次数 */
    VOS_UINT32                      ulFreeTotalCnt;
    VOS_UINT32                      ulFreeNullPtrCnt;       /* 释放空指针次数 */
    VOS_UINT32                      ulFreePtrBeforeCnt;     /* 重复释放次数 */
    VOS_UINT32                      ulMagicTamperedCnt;     /* 魔术字被篡改次数 */
    VOS_UINT32                      ulFreeInvalidPrtCnt;    /* 释放野指针 */
...
typedef  struct
{
    ...
    VOS_UINT16                      usMagic;                        /* 紧跟MemSrc, 用于检查是否出现数据越界 */
    VOS_UINT16                      usIndex;
    PS_QNODE_STATE_ENUM_UINT8       enState;

...
*
*****************************************************************************/
/* DTS2010082601091 BEGIN: Modified by w54542, 2010-8-26 */
BSP_VOID BSP_OM_NET(BSP_OM_NET_S *pstNetOm)
{

}/*lint !e715*/
/* DTS2010082601091 END:   Modified by w54542, 2010-8-26 */
...
/*
 *****************************************************************************
 * Prototype    : DRV_GET_DIEID
 * Description  : GET THE DIEID
 * Input        : buf：data buffer
                  len：length of the group (byte)
...
/*
 *****************************************************************************
 * Prototype    : Test_DIEID
 * Description  : Test  Function DRV_GET_DIEID()
 * Input        :

 * Output       :
 * Return Value :
* Author        : songxiaowei 00249479
 *****************************************************************************
*/
 ...
 *****************************************************************************
 * Prototype    : Test_DIEID
 * Description  : Test  Function DRV_GET_CHIPID()
 * Input        :

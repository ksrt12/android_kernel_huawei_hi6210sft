...
/*****************************************************************************
 函 数 名  : ccoreset_ccpu_freq
 功能描述  : 设置MODEM核的频率为150M
 输入参数  : void
 输出参数  : 无
 返 回 值  : OK or ERROR
 调用函数  :
...
/*DTS2015052502786 chenqihang 00177591 20150527 begin*/
/**
...
/*DTS2015052502786 chenqihang 00177591 20150527 end*/
...
int ccorereset_task(void *arg)
{
...
#endif
    {
       ...
       /*重新加载BBE16核映像*/
        ...
        /*<support ETB, DTS:DTS2013072310354, modifier:liulei+00189326, begin>*/
        //enable_etm_reset(); /*just for compile by x00195127*/
        CCORE_RESET_TASK_PHASE_SET(8);
        /*<support ETB, DTS:DTS2013072310354, modifier:liulei+00189326, end>*/
...
#ifdef CONFIG_HISILICON_PLATFORM_USB
/*****************************************************************************
 函 数 名  : set_for_cshell
 功能描述  : C核单独复位cshell操作接口
 输入参数  : 无
 输出参数  : 无
 返 回 值  : int
 调用函数  :
...
#endif
/*****************************************************************************
 函 数 名  : close_all_filehandle
 功能描述  : C核单独复位rfile操作接口
 输入参数  : 无
 输出参数  : 无
 返 回 值  : int
 调用函数  :

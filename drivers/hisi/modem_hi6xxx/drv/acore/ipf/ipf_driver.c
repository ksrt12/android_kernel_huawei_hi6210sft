...
*
* 功能描述  : modem单独复位后由ADS调用来重新配置下行通道IPF相关寄存器
*
* 输入参数  : 无
* 输出参数  : 无
* 返 回 值  : 无

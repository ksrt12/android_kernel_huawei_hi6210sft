...
/* Add by z40661 for DTS2012101809567 , 2012-09-25, begin */
...
/* Added by f62575 for DTS2013091009786, 2014-03-04,Begin */
/*****************************************************************************
...
/* Added by f62575 for DTS2013091009786, 2014-03-04,End   */
...
typedef struct
{
    /* MOdify by z60575 for dts2012052907939, 2012-5-30 begin */
    ...
    /* MOdify by z60575 for dts2012052907939, 2012-5-30 end */
...
/* Added by l00130025 for DTS2012060400029, 2012-06-09 end */
/*****************************************************************************
...
typedef struct
{
    ...
    /* Modified by z00161729 for DTS2014091200106, 2014-09-16, begin */
    ...
    /* Modified by z00161729 for DTS2014091200106, 2014-09-16, end */
...
typedef struct
{
    ...
    /* Added by M00217266 for B180 DELIVERY, 2013-8-29, Begin */
    VOS_INT16                           sHeadPhoneVolValue;
    VOS_INT16                           sSuperFreeVolValue;
    VOS_INT16                           sSmartTalkVolValue;
    VOS_INT16                           sRsv[7];
    /* Added by M00217266 for B180 DELIVERY, 2013-8-29, End */
...
/* Added by w00176964 for ETWS, 2012-3-28, begin */
/*****************************************************************************
...
/* Added by w00176964 for ETWS, 2012-3-28, end */
...
typedef struct
{
    ...
    /* Modified by l00171473 for DTS2012120600056, 2012-12-4, begin */
    VOS_UINT8                           ucDupDetectCfg;     /* 重复过滤配置 */

    /* Modified by l00171473 for DTS2012120600056, 2012-12-4, end */

    /* Modified by l00171473 for DTS2012120609682, 2012-12-10, begin */
    VOS_UINT8                           ucRptAppFullPageFlg; /* VOS_TRUE: 上报整页共88个字节; VOS_FALSE: 上报实际有效字节 */
    /* Modified by l00171473 for DTS2012120609682, 2012-12-10, end */
...
/*****************************************************************************
 结构名    : TAF_NVIM_WAIT_IMS_VOICE_AVAIL_TIMER_LEN_STRU
...
/* Modified by z00161729 for DTS2013082903019, 2013-9-13, begin */
/*****************************************************************************
...
/* Modified by z00161729 for DTS2013082903019, 2013-9-13, end */

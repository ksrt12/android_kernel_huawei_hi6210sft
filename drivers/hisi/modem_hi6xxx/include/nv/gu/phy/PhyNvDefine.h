...
/*****************************************************************************
 结构名    : UCOM_NV_W_MIPI_PA_ON_WORD_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : WCDMA MIPI PA ON控制字
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          uwValidNumber;
    VOS_UINT16                          auhwMipiCmd[6];
    VOS_UINT16                          auhwMipiData[6];
}UCOM_NV_W_MIPI_PA_ON_WORD_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_G_MIPI_PA_TRIGGER_WORD_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : G MIPI PA Trigger控制字
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          uwValidNumber;
    VOS_UINT16                          auhwMipiCmd[2];
    VOS_UINT16                          auhwMipiData[2];
...
/*****************************************************************************
 结构名    : UCOM_NV_GSM_PA_MIPI_DATA_EXTEND_STRU
 协议表格  :
 结构说明  : PA默认配置数据，最多支持8个,对应CmdFrame,索引方式同CmdFrame
*****************************************************************************/
typedef struct
{
    UCOM_NV_PA_MIPI_DATA_FRAME_STRU         astMipiDataGain[3];

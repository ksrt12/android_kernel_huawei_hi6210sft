...
/*BEGIN DTS2013031100646 c00171433 2013-2-26*/
...
/* s00193151 add for nas plain rej msg DTS2014060603317 2014-05-30 begin */
/* PS功能开关组,是否支持安全激活场景下处理明文拒绝NAS消息标识 */
#define LPS_NV_GET_NAS_PLAIN_REJ_MSG_FLAG_BIT  (0x00001000)
/* s00193151 add for nas plain rej msg DTS2014060603317 2014-05-30 end */

/* s00193151 add for CSFB return to L TAU type2 2014-07-24 begin */
/* PS功能开关组,规避兰州CSFB中兴核心网BUG的NV开关标识 */
#define LPS_NV_GET_NAS_CSFB_TAU_TYPE2_FLAG_BIT  (0x00004000)
/* s00193151 add for CSFB return to L TAU type2 2014-07-24 end */
...
/*add by chenhongqiang c00213443 for cell bar 2012-5-29 begin*/
/* 小区搜索到小区，但是无法接收或者部分接收到系统信息时,用于判断否需要bar小区 */
#define LPS_NV_GET_CELL_SRCH_CELL_BAR_BIT         ( 0x00080000 )
/*add by chenhongqiang c00213443 for cell bar 2012-5-29 end*/
...
/* DTS2013071504226 modified by k00228722 20130715 for lwurc without band limit begin */
/* lwurc 频段限制指示开关 */
#define LPS_NV_LWURC_BAND_LIMIT_FLG_BIT            (0x00000020)
/* DTS2013071504226 modified by k00228722 20130715 for lwurc without band limit end */
/* add for DTS2012101004520 begin */
...
/*lishangfeng 20131213 DTS2013120309818 begin */
#define LPS_NV_SND_ETWS_IMIDIEATELY_BIT           (0x00000080)                  /* 0x80表示为立即发送；0x00表示收齐后再发送 */
/* modify by lishangfeng 20131212 end */
/*lishangfeng 20131213 DTS2013120309818 end */

/*added by z00103912 for L2 OM report 2014-03-11*/
...
/*Add by hanlei DTS20140410008477*/
#define LPS_NV_RRC_BACKTOLTE_REDRECTFAIL_BIT        (0x00000800)
/*begin:added by q00208938 for CA Cell Info Report 2014/06/10*/
#define LPS_NV_L2_CACELLINFO_REPORT_BIT          (0x00002000)                  /*CA SCELL状态信息上报*/
/*end:added by q00208938 for CA Cell Info Report 2014/06/10*/

/* leixiantiao 00258641 2015-06-04 begin */
#define LPS_NV_GET_HO_RETRAN_ESR_MSG_FLAG_BIT     (0x00010000)                  /* ESR过程中发生切换,未发起TAU流程,重发ESR消息控制开关 */
/* leixiantiao 00258641 2015-06-04 end */
...
/* l00150010 add for P-TMSI set active flag begin */
#define LPS_NV_GET_PTMSI_TAU_ACTIVE_FLAG_SUPPORT_BIT (0x00000020)
/* l00150010 add for P-TMSI set active flag end */

/*TDS DSP 自检地址*/
#define ADDR_SELF_ADJUST_PARA       (0x1300F840)
/* add for DTS2012101004520 end */
...
/*DTS2012123000732 begin*/
#define TPS_NV_GCF_CS_LOOP_BIT            ( 0x00000001 )
/*DTS2012123000732 end*/

/* DTS2013022705607 by k00228722 begin */
#define TPS_NV_GCF_DRXEXTRA_CONTROL_BIT            ( 0x00000002 )
/* DTS2013022705607 by k00228722 end */
...
enum PS_NV_INDEX_ENUM
{
    ...
    /* add by chenhongqiang c00213443 AMPR begin */
    NV_IDX_TX_AMPR,
    /* add by chenhongqiang c00213443 AMPR END */

    /*add for DTS2012082505002* begin*/
    NV_IDX_LTE_TX_DIVERSITY_LOSS_COMP,
    /*add for DTS2012082505002* end*/

    /*add for DTS2012101707690 Begin*/
    EN_NV_ID_LTE_TX_AMPR_NS05,
    EN_NV_ID_LTE_TX_AMPR_NS09,
    /*add for DTS2012101707690 End*/
...
/*add for DTS2012100600883 Begin */
/*****************************************************************************
...
typedef struct
{
    ...
    ****************************************************************************/
    ...
    /************************stPsFunFlag03各个BIT含义***************************
     ...
     bitFlag04:
     bitFlag05:
     bitFlag06:  异系统到L,TAU带ACTIVE FLAG定制开关;缺省值:0; 0:关; 1:开
     bitFlag07:
     bitFlag08:
     bitFlag09:
     bitFlag10:
...
/*DTS2013022102447 begin by k00228722*/
/*****************************************************************************
...
/*DTS2013022102447 end by k00228722*/
/*****************************************************************************
...
/*BEGIN c00171433 Fro LTE Band Customize*/
...
/*END c00171433 Fro LTE Band Customize*/
...
/* BEGIN DTS_DCM_IDLE_RESELECTION_CFG_2 c00171433 2012-12-08 Modify*/
typedef struct
{
...
/* END DTS_DCM_IDLE_RESELECTION_CFG_2 c00171433 2012-12-08 Modify*/
...
/*****************************************************************************
 ...
 结构说明  : LTE RRC 阈值
*****************************************************************************/
/* leixiantiao 00258641 sync from kitkat begin */
...
/* leixiantiao 00258641 sync from kitkat end */

/* beigin: DTS2014061805900 2014-07-22 */
extern VOS_UINT8    g_ucTReselectUtran;
extern VOS_UINT8    g_ucTReselectGsm;
/* end: DTS2014061805900 2014-07-22 */

/* Irat TDS UE capability modify by k00228722 begin */
...
/* Irat TDS UE capability modify by k00228722 end */
/*BEGIN DTS2014041603793 c00203521 modify for B28全频段特性*/
/*****************************************************************************
...
/* niuxiufan taiwan modify end */
/* leixiantiao 00258641 DTS2015062509266 2015-07-07 begin */
/* ESR流程发生切换,未发起TAU,重传ESR消息控制开关:规避小区切换后网侧不下发REL问题 */
extern VOS_UINT32  g_ulNasEmmHoRetransEsrFlag;
/* leixiantiao 00258641 DTS2015062509266 2015-07-07 end */
/*****************************************************************************
  8 Fuction Extern
*****************************************************************************/

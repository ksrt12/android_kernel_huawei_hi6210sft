...
/* BEGIN: Added by shijiahong, 2011/12/6   PN:DTS2011120604351*/
typedef struct
{
...
/* END:   Added by shijiahong, 2011/12/6   PN:DTS2011120604351*/
/*****************************************************************************
...
/*BEGIN:added by zengshangyou 2011/9/20  PN:DTS2011090203399*/
typedef struct
{
...
/*END:added by zengshangyou 2011/9/20    PN:DTS2011090203399*/
...
/*begin added by lvxiaoping pn:dts2012050402322*/
typedef struct
{
...
/* BEGIN: Added by b00101152, 2012/8/31   PN: DTS2012082505002*/
typedef struct
{
    INT16  sDivLossComp;
    UINT16 usRes;
}LTE_TX_DIVERSITY_LOSS_COMP;
/* END: Added by b00101152, 2012/8/31   PN: DTS2012082505002*/
typedef struct
{
...
/*end added by lvxiaoping pn:dts2012050402322*/
#endif
typedef struct
{
    ...
    UINT16 ausMprVal[4];
    /*MPR end*/
    /* BEGIN: Added by xueqiuyan, 2012/5/17   PN:DTS2012032702692*/
    UL_AMPR_STRU astAMprVal[LPHY_MAX_BANDWIDTH_NUM];
    /* END:   Added by xueqiuyan, 2012/5/17 */
    /* BEGIN: Added by xueqiuyan, 2012/10/10   PN:DTS2012101707783*/
...
/*begin added by lvxiaoping 20120612 pn:dts2012061205090*/
typedef struct
{
...
/*end added by lvxiaoping 20120612 pn:dts2012061205090*/
...
/*****************************************band无关的nv项*********************************/
/*Begin:Added by liliuwei 00279357 20150612*/
typedef struct
{
...
/*END:Added by liliuwei 00279357 20150612*/

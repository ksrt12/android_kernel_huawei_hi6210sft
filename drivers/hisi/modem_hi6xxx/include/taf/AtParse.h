...
enum AT_RRETURN_CODE_ENUM
{
    ...
    /* Added by s00217060 for DTS2012060507813, 2012-11-07, begin */
    AT_CME_CS_SERV_EXIST,
    /* Added by s00217060 for DTS2012060507813, 2012-11-07, end */

    /* Added by w00176964 for SS FDN&Call Control, 2013-5-16, begin */
    AT_CME_FDN_FAILED,
    AT_CME_CALL_CONTROL_FAILED,
    AT_CME_CALL_CONTROL_BEYOND_CAPABILITY,
    /* Added by w00176964 for SS FDN&Call Control, 2013-5-16, end */
    ...
    /* Added by f00179208 for DTS2013111903762, 2013-11-19, begin */
    AT_CME_NO_SUCH_ELEMENT,
    AT_CME_MISSING_RESOURCE,
    /* Added by f00179208 for DTS2013111903762, 2013-11-19, end */
    ...
    /* Added by l00198894 for AP-Modem Personalisation Project, 2012/04/11, begin */
    ...
    /* Added by l00198894 for AP-Modem Personalisation Project, 2012/04/11, end */
...
/* DTS2012031701527 c64416 start in 2012-03-29 */
...
/* DTS2012031701527 c64416 end in 2012-03-29 */
...
/* Added by A00165503 for PS Project, 2012-02-11, Begin */
...
/* Modified by w00199382 for DTS2012031907202, 2012-3-13, Begin   */
#if (FEATURE_ON == FEATURE_LTE)
...
/* Modified by w00199382 for DTS2012031907202, 2012-3-13, End   */
...
#endif  /* FEATURE_ON == FEATURE_LTE */
/* Added by A00165503 for PS Project, 2012-02-11, End */
...
#else
/* Modified  by f62575 for DTS2011112307607, 2011-11-24, begin */
/* Modified  by z60575 for DTS2012070400072, 2012-7-6, begin */
/* Modified by Y00213812 for DTS2013032204300, 2013-06-18, begin */
...
/* Modified by Y00213812 for DTS2013032204300, 2013-06-18, end */
/* Modified  by z60575 for DTS2012070400072, 2012-7-6, end */
...
/* Added by f62575 for DTS2011112307607, 2011-11-24, begin */
#if (PS_UE_REL_VER < PS_PTL_VER_R5)
...
/* Modified by Y00213812 for DTS2013032204300, 2013-06-18, end */
#endif
/* Added by f62575 for DTS2011112307607, 2011-11-24, end */
...
typedef struct
{
    ...
    /* Added by l00171473 for V7R1C50_At_Abort, 2012-9-18, begin */
    PFN_AT_FW_CMD_PROC      pfnAbortProc;
    VOS_UINT32              ulAbortTimeOut;
    /* Added by l00171473 for V7R1C50_At_Abort, 2012-9-18, end */
...
/* DTS2012051201779 c64416 start in 2012-05-31 for CPBW */
...
/* DTS2012051201779 c64416 end in 2012-05-31 for CPBW */
...
/* Modified by c64416 DTS2011122601380 for Block cmd 2011-12-31  Begin*/
extern VOS_VOID AT_CheckProcBlockCmd(VOS_VOID);
/* Modified by c64416 DTS2011122601380 for Block cmd 2011-12-31  end*/
...
/* Modified by w00167002 for NETSCAN, 2013-10-19, begin */
VOS_UINT32 AT_IsAbortCmdStr(
    VOS_UINT8                           ucIndex,
    VOS_UINT8                          *pucData,
    VOS_UINT16                          usLen
);
/* Modified by w00167002 for NETSCAN, 2013-10-19, end */

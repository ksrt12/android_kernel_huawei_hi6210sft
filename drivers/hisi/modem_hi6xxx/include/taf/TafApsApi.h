...
/* Added by A00165503 for DTS2013022201185, 2014-02-20, Begin */
#if (FEATURE_ON == FEATURE_LTE)
    /* 注册承载激活指示 */
    ID_MSG_TAF_PS_ATTACH_BEARER_ACTIVATE_IND                = TAF_PS_MSG_ID_BASE + 0x0202,  /* _H2ASN_MsgChoice */
#endif
/* Added by A00165503 for DTS2013022201185, 2014-02-20, End */
...
typedef struct
{
    ...
    /* wangchen 00209181 begin for P-CSCF 2015-03-06 */
    VOS_UINT32                          bitOpThiPcscfAddr   : 1;
    VOS_UINT32                          bitOpSpare          : 29;
    /* wangchen 00209181 end for P-CSCF 2015-03-06 */
...
typedef struct
{
    /* Modified by A00165503 for DTS2014030404070, 2014-03-03, Begin */
    TAF_PDP_ADDR_STRU                   stPdpAddr;
    TAF_PDP_APN_STRU                    stApn;
    /* Modified by A00165503 for DTS2014030404070, 2014-03-03, End */
...
typedef struct
{
    ...
    /* Modified by f00179208 for VTLTE, 2014-06-16, Begin */
    VOS_UINT32                          bitOpTft            : 1;
    VOS_UINT32                          bitOpSpare          : 23;
    /* Modified by f00179208 for VTLTE, 2014-06-16, End */
...
/* Added by f00179208 for V3R3 PPP RPOJECT 2013-06-06, Begin */
typedef struct
{
    TAF_CTRL_STRU                       stCtrl;
...
/* Added by f00179208 for V3R3 PPP RPOJECT 2013-06-06, End */
...
typedef struct
{
    ...
    VOS_UINT32                          bitOpPcscfDiscovery : 1;
    VOS_UINT32                          bitOpImCnSignalFlg  : 1;
    /* Modified by z00301431 for DTS2015072702142, 2015-7-29 begin*/
    VOS_UINT32                          bitOpImsSuppFlg     : 1;
    VOS_UINT32                          bitOpSpare          : 21;
    /* Modified by z00301431 for DTS2015072702142, 2015-7-29 end*/

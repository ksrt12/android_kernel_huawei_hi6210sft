...
/*****************************************************************************
结构名    : TAF_MMA_AC_INFO_QUERY_REQ_STRU
结构说明  : AT^ACINFO查询请求结构
...
/*****************************************************************************
结构名    : TAF_MMA_AC_INFO_QUERY_CNF_STRU
结构说明  : AT^ACINFO查询请求回复结构
...
/*****************************************************************************
 结构名    : TAF_HPLMN_WITH_MNC_LEN_STRU
 结构说明  : 带有MNC长度HPLMN值
 1.日    期   : 2012年04月18日
   作    者   : w00166186
   修改内容   : 新建
...
/*****************************************************************************
 结构名    : TAF_DOMAIN_ATTACH_STATE_STRU
 结构说明  : 查询CS和PS注册状态。
...
/* Added by w00242748 for NETSCAN, 2013-10-15, begin */
/*****************************************************************************
 结构名    : TAF_MMA_NET_SCAN_REQ_STRU
 结构说明  : AT和MMA的NETSCAN设置接口
 1.日    期  : 2013年10月10日
   作    者  : w00242748
   修改内容  : 新增结构
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_NET_SCAN_CNF_STRU
 结构说明  : MMA上报给AT的NETSCAN CNF接口
 1.日    期  : 2013年10月10日
   作    者  : w00242748
   修改内容  : 新增结构
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_PH_PLMN_SELECTION_INFO_STRU
...
/* Added by l00198894 for B050 Project, 2012/02/02, begin */
/*****************************************************************************
结构名    : MN_MMA_CIPHER_QRY_REQ_STRU
结构说明  : AT^CIPHERQRY查询请求结构
...
/*****************************************************************************
结构名    : MN_MMA_CIPHER_QRY_CNF_STRU
结构说明  : AT^CIPHERQRY查询请求回复结构
...
/*****************************************************************************
结构名    : MN_MMA_LOCATION_INFO_REQ_STRU
结构说明  : AT^LOCINFO查询请求结构
...
/*****************************************************************************
结构名    : MN_MMA_LOCATION_INFO_CNF_STRU
结构说明  : AT^LOCINFO查询请求回复结构
...
/*****************************************************************************
结构名    : MN_MMA_CRPN_QRY_CNF_MSG_STRU
结构说明  : AT^CRPN查询请求回复消息结构
...
/*****************************************************************************
结构名    : MN_MM_TEST_CMD_RSP_MSG_STRU
结构说明  : AT^CMM查询命令MMA回复AT命令消息结构定义
...
/*****************************************************************************
结构名    : TAF_MMA_CERSSI_INFO_QUERY_CNF_STRU
结构说明  : AT^CERSSI查询请求回复结构
  ...
  2.日    期   : 2014年01月29日
    作    者   : f62575
    修改内容   : DTS2014012605458: ^CERSSI查询结果<EC/IO>显示错误，删除ucCurrentUtranMode
*******************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
...
/*****************************************************************************
结构名    : TAF_MMA_CPOL_INFO_QUERY_CNF_STRU
结构说明  : AT+CPOL查询请求回复结构
修改历史      :
  1.日    期   : 2014年01月15日
    作    者   : f62575
    修改内容   : DTS2014011301359，+CPOL命令支持超过37个UPLMN
...
/* Added by s00190137 for SIM Insert, 2013/07/04, begin */
/*****************************************************************************
结构名    : TAF_MMA_SIM_INSERT_IND_STRU
结构说明  : AT^SIMINSERT指示卡插入或移除状态
...
/*****************************************************************************
结构名    : TAF_MMA_SIM_INSERT_RSP_STRU
结构说明  : AT^SIMINSERT请求回复结构
修改历史      :
  1.日    期   : 2013年7月4日
    作    者   : s00190137
    修改内容   : add for SIM Insert

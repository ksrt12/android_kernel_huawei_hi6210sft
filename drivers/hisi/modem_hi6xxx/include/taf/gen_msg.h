...
/* added by z00212940 for TDS, 2012-7-25 begin */
...
/* added by z00212940 for TDS, 2012-7-25 end */
...
/* Add: Added by l00169177 V9R1_Hi6361 Verification */
...
/*END:   Added by l00169177 fort Multi-RF 20130904*/
...
enum
{
    ...
    /*Begin DTS2013050703885 daizhicheng 2013-05-07 Added for TDS */
    EN_SYM_TMODE_GU_BT              = 16,
    EN_SYM_TMODE_TDS_FAST_CT        = 17,
    EN_SYM_TMODE_TDS_BT             = 18,
    /*End DTS2013050703885 daizhicheng 2013-05-07 Added for TDS */
	/* Added by y00193980 for common CT, 2013-08-10, begin DTS2013081504790 */
    EN_SYM_TMODE_COMM_CT            = 19,
    /* Added by y00193980 for common CT, 2013-08-10, end DTS2013081504790*/
...
typedef struct
{
    ...
    /* 4:输入频段和信道信息无法组合*/
    /* 5:其它错误*/
    FCHAN_MODE_ENUM enFchanMode; /* lkf58113 @ 20111102 add*/
    VOS_UINT32 ulErrCode;
...
/* DTS2012021003133  c64416 start in 2012-02-08 for wifi*/
...
/* DTS2012021003133  c64416 end in 2012-02-08 for wifi*/
...
/*Begin: Added by l00169177 20130820 */
    EN_FWAVE_TYPE_CDMA,      /*  CDMA调制波  */
    EN_FWAVE_TYPE_TDS,       /*  TDS调制波   */
/*End  : Added by l00169177 20130820 */
...
/* BEGIN: Added by l00169177 20130813 DTS2013081300992 */
#define FTM_MAX_TDS_BAND_NUM 6
/* END: Added by l00169177 20130813 DTS2013081300992 */
...
/* Begin : Modified by l00169177 for common command 20131012 DTS2013102305491 */
typedef struct
{
    VOS_UINT16 usbler[2];
	VOS_INT16 usSnr[2];
...
/* End  : Modified by l00169177 for common command 20131012 DTS2013102305491 */

/* begin_added by s00184745 for bt tds nosig 20130516 */
//TDS BER RD
typedef struct
{
    VOS_UINT32 ulReserved;
...
/*end_added by s00184745 for bt tds nosig*/
...
/* Modified by y00193980 for common CT, 2013-08-10, begin DTS2013081504790 */
/* AT^FCALITXIQS */
typedef struct
{
	VOS_UINT16 usChannel;
...
/* Modified by y00193980 for common CT, 2013-08-10, end DTS2013081504790 */
...
/* Begin : Added by l00169177 for common at command 20131012 DTS2013102611180 */
...
/* End   : Added by l00169177 for common at command 20131012 DTS2013102611180 */

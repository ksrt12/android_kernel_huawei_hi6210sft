...
/* Added by f00179208 for LTE PPP, 2012-08-10, Begin */
/*****************************************************************************
...
/* Added by f00179208 for LTE PPP, 2012-08-10, End */
...
{
    /* Modified by f00179208 for DTS2012091103224, 2012-09-12 Begin */
    APS_L4A_GW_AUTH_TYPE_NONE                   = 0x00,
    APS_L4A_GW_AUTH_TYPE_PAP                    = 0x01,
    APS_L4A_GW_AUTH_TYPE_CHAP                   = 0x02,
    /* Modified by f00179208 for DTS2012091103224, 2012-09-12 End */
...
/*****************************************************************************
 结构名: APS_L4A_PDP_PCSCF_STRU
 结构说明: Protocol config option中的P-CSCF结构
 1.日    期   : 2011年12月10日
   作    者   : a00165503
   修改内容   : Added for PS融合
*****************************************************************************/
...
/*****************************************************************************
 结构名: APS_L4A_PDP_GATEWAY_STRU
 结构说明: IPCP报文中的GateWay结构
 1.日    期   : 2011年12月10日
   作    者   : a00165503
   修改内容   : Added for PS融合
*****************************************************************************/
...
/*****************************************************************************
 结构名: APS_L4A_PDP_IPV6_DNS_STRU
 结构说明: Protocol config option中的IPv6 DNS结构
 1.日    期   : 2011年12月10日
   作    者   : a00165503
   修改内容   : Added for PS融合
*****************************************************************************/
...
/*****************************************************************************
 结构名    : APS_L4A_PDP_ACTIVATE_CNF_STRU
 结构说明  : ID_APS_L4A_PDP_ACTIVATE_CNF消息结构体
             1) ulEsmCause需要转换错误码区间
 1.日    期   : 2011年12月10日
   作    者   : a00165503
   修改内容   : Added for PS融合
*****************************************************************************/
...
/*****************************************************************************
 结构名    : APS_L4A_PDP_ACTIVATE_REJ_STRU
 结构说明  : ID_APS_L4A_PDP_ACTIVATE_REJ消息结构体
             1) ulEsmCause需要转换错误码区间
 1.日    期   : 2011年12月10日
   作    者   : a00165503
   修改内容   : Added for PS融合
...
/*****************************************************************************
 结构名    : APS_L4A_PDP_ACTIVATE_IND_STRU
 结构说明  : ID_APS_L4A_PDP_ACTIVATE_IND消息结构体
 1.日    期   : 2011年12月10日
   作    者   : a00165503
   修改内容   : Added for PS融合
*****************************************************************************/
...
/*****************************************************************************
 结构名    : APS_L4A_PDP_MODIFY_CNF_STRU
 结构说明  : ID_APS_L4A_PDP_MODIFY_CNF消息结构体
 1.日    期   : 2011年12月10日
   作    者   : a00165503
   修改内容   : Added for PS融合
*****************************************************************************/
...
/*****************************************************************************
 结构名    : APS_L4A_PDP_MODIFY_REJ_STRU
 结构说明  : ID_APS_L4A_PDP_MODIFY_REJ消息结构体
             1) ulEsmCause需要转换错误码区间
 1.日    期   : 2011年12月10日
   作    者   : a00165503
   修改内容   : Added for PS融合
...
/*****************************************************************************
 结构名    : APS_L4A_PDP_MODIFY_IND_STRU
 结构说明  : ID_APS_L4A_PDP_MODIFY_IND消息结构体
 1.日    期   : 2011年12月10日
   作    者   : a00165503
   修改内容   : Added for PS融合
*****************************************************************************/
...
/*****************************************************************************
 结构名    : APS_L4A_PDP_DEACTIVATE_CNF_STRU
 结构说明  : ID_APS_L4A_PDP_DEACTIVATE_CNF消息结构体
             1) stIpAddrInfo只需要填写IP类型(IPv4, IPv6, IPv4v6)
 1.日    期   : 2011年12月10日
   作    者   : a00165503
   修改内容   : Added for PS融合
*****************************************************************************/
...
/*****************************************************************************
 结构名    : APS_L4A_PDP_DEACTIVATE_IND_STRU
 结构说明  : ID_APS_L4A_PDP_DEACTIVATE_IND消息结构体
             1) ulEsmCause需要转换错误码区间
             2) stIpAddrInfo只需要填写IP类型(IPv4, IPv6, IPv4v6)
 1.日    期   : 2011年12月10日
   作    者   : a00165503
   修改内容   : Added for PS融合
*****************************************************************************/
...
/*****************************************************************************
 结构名    : APS_L4A_SET_NDISCONN_CNF_STRU
 结构说明  : ID_APS_L4A_SET_NDISCONN_CNF消息结构体
 1.日    期   : 2011年12月10日
   作    者   : a00165503
   修改内容   : Added for PS融合
*****************************************************************************/
...
typedef struct
{
    ...
    /* Modified by Y00213812 for VoLTE_PhaseIII, 2013-12-10, begin */
    APS_L4A_APPCTRL_STRU                stCtrl;
    /* Modified by Y00213812 for VoLTE_PhaseIII, 2013-12-10, end */
    VOS_UINT32                          ulErrorCode;                            /* 错误码     */
...
typedef struct
{
    ...
    VOS_UINT32                          ulSecuParaIndex;                        /* value range is from 00000000 to FFFFFFFF */
...
/*****************************************************************************
 结构名    : APS_L4A_SET_CGCMOD_CNF_STRU
 结构说明  : ID_APS_L4A_SET_CGCMOD_CNF消息结构体
 1.日    期   : 2011年12月14日
   作    者   : c00184452
   修改内容   : Added for PS融合
*****************************************************************************/
...
/*****************************************************************************
 结构名    : APS_L4A_NDISCONN_STRU
 结构说明  : NDIS拨号，L4A需要的拨号相关参数
  1.日    期   : 2011年12月12日
    作    者   : h44270
    修改内容   : Added for PS融合
  ...
  2.日    期   : 2012年08月13日
    作    者   : f00179208
    修改内容   : LTE PPP:将PDP去激活与激活拆分开来

  3.日    期   : 2014年5月16日
    作    者   : A00165503
    修改内容   : DTS2014050703206: 增加IMS相关参数
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 结构名称: APS_L4A_PPP_DIAL_REQ_STRU
 结构说明: The struct of ID_APS_L4A_PPP_DIAL_REQ.
           stAppCtrl - Client information
           stPppInfo - PPP information
...
/*****************************************************************************
 结构名    : APS_L4A_PPP_DIAL_CNF_STRU
 结构说明  : The struct of ID_APS_L4A_PPP_DIAL_CNF.
...
/*****************************************************************************
 结构名    : APS_L4A_PS_CALL_END_REQ_STRU
 结构说明  : The struct of ID_APS_L4A_PS_CALL_END_REQ.
...
/*****************************************************************************
 结构名    : APS_L4A_PS_CALL_END_CNF_STRU
 结构说明  : The struct of ID_L4A_APS_PS_CALL_END_CNF.

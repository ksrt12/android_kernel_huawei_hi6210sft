...
/* Added by w00176964 for DTS2013030606529, 2013-3-7, begin */
...
/* Added by w00176964 for DTS2013030606529, 2013-3-7, end */
...
/* Modified by j00174725 for ECC(DTS2017021705267), 2017-02-18, begin */
...
enum TAF_CALL_VOICE_DOMAIN_ENUM
{
    ...
    /* Added by Y00213812 for CDMA 1X Iteration 2, 2014-09-05, begin */
    TAF_CALL_VOICE_DOMAIN_3GPP2  = 2,
    /* Added by Y00213812 for CDMA 1X Iteration 2, 2014-09-05, end */
...
{
    /* Modified by f00179208 for DTS2012061204249, 2012/06/13, begin */
    ...
    /* Added by y00245242 for VoLTE_PhaseIII, 2013-12-14, begin */
    MN_CALL_S_WAITING_ACCEPT,                                                   /* 该状态为SRVCC过程前用户接听失败，成功后在GU下发送connect */
    /* Added by y00245242 for VoLTE_PhaseIII, 2013-12-14, end */

    MN_CALL_S_BUTT
    /* Modified by f00179208 for DTS2012061204249, 2012/06/13, End */
};
typedef VOS_UINT8  MN_CALL_STATE_ENUM_U8;


/* Modified by z00161729 for DSDS III, 2014-6-13, begin */
/*****************************************************************************
...
/* Modified by z00161729 for DSDS III, 2014-6-13, end */
...
typedef VOS_UINT8   MN_CALL_CS_DATA_SPD_SIMPLE_ENUM_U8;
 ...
 typedef struct
 {
    ...
    MN_CALL_CS_DATA_NAME_ENUM_U8       enName;
    MN_CALL_CS_DATA_CE_ENUM_U8         enConnElem;
    /* Added by f00179208 for DTS2012052100994, 2012-05-21 Begin */
    VOS_UINT8                          aucReserved1[5];
    /* Added by f00179208 for DTS2012052100994, 2012-05-21 End */
...
enum MN_CALL_EVENT_ENUM
{
    ...
    /* Added by c00173809 for At Project, 2011-10-17, Begin */
...
/* Modified by s00217060 for cs_err_log, 2014-09-25 Begin */
/* 把原有的枚举定义进行调整 */
...
enum TAF_CS_CAUSE_ENUM
{
    ...
    /* Modified by z00161729 for DSDS III, 2014-6-24, begin */
    TAF_CS_CAUSE_NO_RF                                              = (TAF_CS_CAUSE_CALL_BEGIN + 30),
    /* Modified by z00161729 for DSDS III, 2014-6-24, end */
    ...
    /* Modified by s00217060 for cs_err_log, 2014-09-25 End */
    ...
    /* leixiantiao 00258641 DTS2015121609605 2015-12-10 begin */
    /* 新增原因值, 该原因值用于不用去CS域重播时的IMS SIP原因值转换 */
    TAF_CS_CAUSE_IMS_OTHERS                                         = (TAF_CS_CAUSE_IMS_BEGIN + 699),
    /* leixiantiao 00258641 DTS2015121609605 2015-12-10 end */
    ...
    /* Added by x00253310 for strm rtp 20150629 begin */
    TAF_CS_CAUSE_IMSA_STRM_RTP_BREAK                                = (TAF_CS_CAUSE_IMSA_BEGIN + 14),           /* 通话中没有语音包 */
    /* Added by x00253310 for strm rtp 20150629 end   */
    ...
    /* leixiantiao 00258641 DTS2015121609605 2015-12-10 end */
    /* Added by wangchen 00209181 2015-11-27 for volte dsds,begin */
    TAF_CS_CAUSE_IMSA_NO_RF                                         = (TAF_CS_CAUSE_IMSA_BEGIN + 16),           /* DSDS没有申请到资源 */
    /* Added by wangchen 00209181 2015-11-27 for volte dsds,end */
...
/* Added by l00198894 for DTS2012100901666, 2012/10/29, begin */
...
/* Added by l00198894 for DTS2012100901666, 2012/10/29, end */
...
/* Added by Y00213812 for DTS2013012909872, 2012-10-23, begin */
/*****************************************************************************
 结构名    : MN_CALL_CALLED_NUM_STRU
 结构说明  : 被叫号码结构体
...
/* Added by Y00213812 for DTS2013012909872, 2012-10-23, end */
...
typedef struct
{
    ...
    /* Modified by f00179208 for enhanced conference, 2014-11-28, Begin */
    VOS_UINT8                           ucEconfFlag;
    /* Modified by f00179208 for enhanced conference, 2014-11-28, End */
    /* Modified by z00161729 for DSDS III, 2014-6-13, end */
    /* Added by y00213812 for STK&DCM Project, 2012/09/18, end */
...
typedef struct
{
    ...
    /* Added by y00245242 for DTS2014031105153, 2014-2-13, begin */
    ...
    VOS_UINT8                           aucReserved[2];
    /* Added by y00245242 for DTS2014031105153, 2014-2-13, end */
...
/*Added by c00173809 for AT Project,2011-10-8,Begin */
/*****************************************************************************
...
typedef struct
{
    ...
    VOS_UINT32                          ulMcc;                                  /* MCC,3 bytes */
    MN_CALL_BCD_NUM_STRU                stEccNum;                               /* 紧急呼号码 */
    /* Added by l00198894 for DTS2014110508255, 2014-12-20, begin */
    VOS_UINT8                           ucAbnormalServiceFlg;                   /* 紧急呼号码有卡时是否仅在非正常服务时有效，0:任何服务时均有效，1:仅非正常服务时有效 */
    VOS_UINT8                           aucReserved[3];
    /* Added by l00198894 for DTS2014110508255, 2014-12-20, end */
...
typedef struct
{
    ...
    /* Modified by l00198894 for DTS2014110508255, 2014-12-20, begin */
    VOS_UINT8                           ucAbnormalServiceFlg;                   /* 紧急呼号码有卡时是否仅在非正常服务时有效，0:任何服务时均有效，1:仅非正常服务时有效 */
    /* Modified by l00198894 for DTS2014110508255, 2014-12-20, end */
...
enum MN_CALL_CHANNEL_EVENT_ENUM
{
    ...
    /* Modified by z00161729 for V9R1_SVLTE, 2013-6-9, begin */
    MN_CALL_EVT_CHANNEL_LOCAL_ALERTING,
    /* Modified by z00161729 for V9R1_SVLTE, 2013-6-9, end */
...
/* Modified by w00176964 for DTS2014032901140, 2014-3-29, begin */
typedef struct
{
    MN_CALL_EVENT_ENUM_U32              enEvent;                                /* 事件名 */
    MN_CLIENT_ID_T                      usClientId;
...
/* Modified by w00176964 for DTS2014032901140, 2014-3-29, end */
...
/* Get All Call Info */
/* Modified by f00179208 for At Project, 2011-10-17, Begin */

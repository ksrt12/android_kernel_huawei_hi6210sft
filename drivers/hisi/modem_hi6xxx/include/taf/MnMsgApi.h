 ...
 ******************************************************************************
  ...
  4.日    期   : 2008年8月26日
    作    者   : 傅映君 62575
    修改内容   : 问题单号 AT2D05214,新增MSG模块与AT间消息解析功能
  5.日    期   : 2008年09月08日
    作    者   : f62575
...
/* Modified by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-3-22, begin */
...
/* Modified by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-3-22, end */
...
/*****************************************************************************
  3 类型定义
*****************************************************************************/
/* Added by f62575 for DTS2012123101285, 2013-01-03, begin */
/*****************************************************************************
...
/* Added by f62575 for DTS2012123101285, 2013-01-03, end   */
...
/* Added by w00167002 for NETSCAN, 2013-10-17, begin */
...
/* Added by w00167002 for NETSCAN, 2013-10-17, end */
...
/* Added by s00217060 for V9R1_SVLTE, 2013-6-19, begin */
...
/* Added by s00217060 for V9R1_SVLTE, 2013-6-19, end */
...
/*Modified by f62575 for DTS2011051202290, 2011-05-12, begin */
...
/*Modified by f62575 for DTS2011051202290, 2011-05-12, end   */
...
/* Added by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-3-30, begin */
...
/* Added by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-3-30, end */
/*****************************************************************************
  7 STRUCT定义
*****************************************************************************/
...
typedef struct
{
    ...
    /* Modified by w00167002 for NETSCAN, 2013-10-10, begin */
    MN_MSG_CNMI_MT_TYPE_ENUM_U8         enMtType;
    /* Modified by w00167002 for NETSCAN, 2013-10-10, end */
...
enum TAF_MSG_ERROR_ENUM
{
    ...
    /* Add by j00174725 for DTS2015102702397, 2015-11-12, begin */
    ...
    /* Add by j00174725 for DTS2015102702397, 2015-11-12, end */
...
/* Modified by w00167002 for DTS2013092100149, 2013-9-30, begin */
/*****************************************************************************
...
typedef struct
{
    ...
    /* Modified by w00167002 for DTS2013092100149, 2013-9-29, begin */
    VOS_UINT8                           ucIsFirstTimeReq;                       /* 消息请求类型:VOS_TRUE 表示首次请求，VOS_FALSE表示请求上报余下部分MSG */
    VOS_UINT8                           aucReserve1[1];
    /* Modified by w00167002 for DTS2013092100149, 2013-9-29, end */
    VOS_BOOL                            bChangeFlag;                            /*change status or not change status after read or list*/
}MN_MSG_LIST_PARM_STRU;
/* Modified by w00167002 for DTS2013092100149, 2013-9-30, end */
...
typedef struct
{
    ...
    /* Added by w00167002 for DTS2013092100149, 2013-9-30, begin */
    MN_MSG_LIST_PARM_STRU               stReceivedListPara;                     /* 上报收到的LIST参数信息 */
    /* Added by w00167002 for DTS2013092100149, 2013-9-30, end */
...
/* Modified by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-3-21, begin */
...
/* Modified by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-3-21, end */
...
/* Added by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-3-1, begin */
...
/* Added by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-3-1, end */
...
enum MN_MSG_EVENT_ENUM
{
    ...
    /* Added by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-3-29, begin */
    MN_MSG_EVT_DELIVER_ETWS_PRIM_NOTIFY,                                        /* rcv a new primary notify */
    /* Added by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-3-29, end */
    /*#endif*/
    MN_MSG_EVT_MAX
};
...
/*Modified by f62575 for DTS2011052703494, 2011-06-1, begin */
...
/*Modified by f62575 for DTS2011052703494, 2011-06-1, end   */

/* Added by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-4-5, begin */
...
/* Added by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-4-5, end */

/* Added by x00182239 for DTS2014120310853, 2015-01-14, begin */
...
/* Added by x00182239 for DTS2014120310853, 2015-01-14, end */

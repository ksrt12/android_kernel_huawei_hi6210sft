 ...
 ******************************************************************************
  ...
  生成日期   : 2010年10月8日
  最近修改   :
  功能描述   : PsLog.c 中关于Errlog功能部分的头文件
               这个头文件需要生成ErrLog.dll, 具体是从ErrorLog.h生成ErrLog.asn,
               再转换成ErrLog.dll
               在自动转成.asn后, 需要在.ash中添加VOS-BOOL, VOS_CHAR的ASN定义,
               ERR-LOG-MSG-DATA需要手动改成"ERR-LOG-MSG-DATA    ::= <V> SEQUENCE"
               最后一个结构的名称必须是"ErrorLog-MSG"
               还有头文件中_H2ASN_Skip, 不要去掉, 跟ASN相关
  函数列表   :
  修改历史   :
  1.日    期   :
    作    者   :
...
/*Added by L00167020 for DTS2011022402817,2010-02-14,begin*/
/*30分钟内记录的弱信号发生的最大次数*/
#define GAS_MNTN_WEAK_SIGNAL_LIST_MAX_NUM                       (30)
/*Added by L00167020 for DTS2011022402817,2010-02-14,end*/
...
enum MNTN_WRITEFLASH_EVENT_ENUM
{
    ...
    /*Modified by L00167020 for DTS2011022402817,2010-02-14,begin*/
    MNTN_GAS_INIT_WEAK_SIGNAL_EVENT             = 0x00000201,           /* _H2ASN_MsgChoice GAS_MNTN_INIT_WEAK_SIGNAL_EVT_STRU */
    /*Modified by L00167020 for DTS2011022402817,2010-02-14,end*/

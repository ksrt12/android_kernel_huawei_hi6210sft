...
#define SI_PB_STORAGE_SD                8       /*存储器类型为SDN*/
...
typedef struct
{
    ...
    SI_PB_STORATE_TYPE                  enPbType;           /* 电话本类型,此时会指定SDN或FDN */
...
extern VOS_UINT32 SI_PB_EcallNumberQry(VOS_UINT32 ulPid, SI_PB_STORATE_TYPE  Storage, VOS_UINT8 ucListLen, VOS_UINT8 *pucList);

...
#define FEATURE_LMAC_LPHY_R10_CR     LMAC_FEATURE_ON
...
enum LMAC_LPHY_MSG_TYPE_ENUM
{
    ...
    ID_LMAC_LPHY_DSDS_RF_USED_IND         = (LPHY_ULLMAC_MSG_HDR + 0x0e),
...
enum LTE_MAC_PHY_ERR_IND_ENUM
{
    ...
    LTE_MAC_PHY_ERR_OTHER                 = 3,                                  /*其他错误上报*/
...
extern VOS_UINT8        g_aucDediDlTbQue[512];

...
/* BEGIN DTS2012122008453 c00171433 2012-01-08*/
#include  "AppRrcLteCommonInterface.h"
/* END DTS2012122008453 c00171433 2012-01-08*/
...
enum APP_RRC_MSG_ID_ENUM
{
    ...
    /* yangfan Prob End */
    /* DTS2013091104339 modified by k00228722 begin */
    ...
    /* DTS2013091104339 modified by k00228722 end */
    ...
    /* add by zhuochao for DTS2013082701742 begin 20130822*/
    ...
    /* add by zhuochao for DTS2013082701742 end 20130822 */
    /* add by zhuochao for SSAC DTS2013102102411 20130929 begin */
    ID_RRC_APP_SSAC_DBG_INFO_IND                 = (PS_MSG_ID_RRC_TO_APP_BASE + 0x3f),
    /* add by zhuochao for SSAC DTS2013102102411 20130929 end */
    ID_LRRC_APP_SET_UE_REL_VERSION_CNF      = (PS_MSG_ID_RRC_TO_APP_BASE + 0x40),/* _H2ASN_MsgChoice LRRC_APP_SET_UE_REL_VERSION_CNF_STRU  */
   /* begin:V7R2-DT add dt cnf msg,c00134407,2014/5/21 */
    ...
    /* end:V7R2-DT add dt cnf msg,c00134407,2014/5/21 */
...
/*****************************************************************************
 ...
 结构说明  : RRC上报的协议状态
*****************************************************************************/
/*V7R2-DT ,l00195322,2014/4/25, begin*/
typedef struct
{
    VOS_MSG_HEADER                                          /*_H2ASN_Skip*/
    VOS_UINT32                          ulMsgId;            /*_H2ASN_Skip*/
...
/*V7R2-DT ,l00195322,2014/4/25, end*/
...
/* BEGIN DTS_DCM_IDLE_RESELECTION_CFG c00171433 2012-12-08 Add*/
/*****************************************************************************
...
typedef struct
{
    ...
    APP_MSG_HEADER
    VOS_UINT32                          ulOpId;
    /*BEGIN DTS_IDLE_RESELECTION_CFG_2 c00171433 Modify*/
    VOS_UINT32                           ulFlag;
    /*END DTS_IDLE_RESELECTION_CFG_2 c00171433 Modify*/
...
/* Modified by y00193980 for common CT, 2013-08-10, begin */
...
/* Modified by y00193980 for common CT, 2013-08-10, end */

...
/*add by lifuxin 00253982 2014-03-03 for migrating from VXWORKS to new os start*/
...
#else
#define    LPS_CacheClear(pDataAddr, ulDataLen)         OSAL_CacheFlush(OSAL_DATA_CACHE, (VOS_VOID *)(pDataAddr), (ulDataLen))
#define    LPS_CacheFlush(pDataAddr, ulDataLen)         OSAL_CacheFlush(OSAL_DATA_CACHE, (VOS_VOID *)(pDataAddr), (ulDataLen))
#define    LPS_CacheInvalidate(pDataAddr, ulDataLen)    OSAL_CacheInvalid(OSAL_DATA_CACHE, (VOS_VOID *)(pDataAddr), (ulDataLen))
#endif
#if (VOS_OS_VER == VOS_RTOSCK)
#define    LPS_CacheDmaMalloc(ulSize,pDataAddr)          OSAL_CacheDmaMalloc(ulSize)
#define    LPS_CacheDmaFree(pBuf,ulSize)                 OSAL_CacheDmaFree(pBuf)
#else
...
#endif
#endif
/*add by lifuxin 00253982 2014-03-03 for migrating from VXWORKS to new os end*/

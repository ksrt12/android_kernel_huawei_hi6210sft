...
enum    BST_CDS_MSG_ID_ENUM
{
    ...
    ID_BST_CDS_TX_RX_IND,                         /* _H2ASN_MsgChoice BST_CDS_TX_RX_MSG_STRU */

    /* BASTET发给CDS的消息原语: 配置CDS是否发送TX_RX_IND消息 */
    ID_BST_CDS_TX_RX_RPT_CTRL_REQ,                /* _H2ASN_MsgChoice BST_CDS_TX_RX_RPT_ENABLE_STRU */
    ...
    /* 勾包信息: CDS  到BASTET的下行数据包*/
    ID_BST_CDS_DL_IP_PKG_INFO_IND,                /* _H2ASN_MsgChoice BST_CDS_HOOK_STRU */

    /* 勾包信息: BASTET  到CDS 的上行数据包*/
    ID_BST_CDS_UL_IP_PKG_INFO_IND,                /* _H2ASN_MsgChoice BST_CDS_HOOK_STRU */
    
    /* 勾包信息: BASTET  到CDS 的转发给AP的上行数据包*/
    ID_BST_CDS_FW_IP_PKG_INFO_IND,               /* _H2ASN_MsgChoice BST_CDS_HOOK_STRU */

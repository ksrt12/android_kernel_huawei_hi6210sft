/*******************************************************************************
  ...
  File name    : NasOmInterface.h
  Description  : NAS与OM模块接口定义
  Function List:

  History:
      1.  x115505   2008.04.29 新版做成
      2. Date:          2008-12-11
         Author:        f62575
      ...
      5.日    期   : 2012年04月28日
        作    者   : L00171473
        修改内容   : DTS2011102200898, 由于TRANS消息和EVENT消息的顶级结构不同，为了ASN解析TRANS
                     消息, 将该头文件中的TRANS消息相关部分提取到新增的NasOmTrans.h 中
*******************************************************************************/
...
typedef enum
{
    ...
    /* Modified by s00217060 for cs_err_log, 2014-09-26 Begin */
    NAS_OM_EVENT_SMS_MT_FAIL,
    /* Modified by s00217060 for cs_err_log, 2014-09-26 End */
...
typedef enum
{
    ...
    NAS_OTA_MSG_ABORT,
    /* Modified by z00161729 for DTS2013101007129, 2013-10-11, begin */
    NAS_OTA_MSG_MM_STA_N2M,
    /* Modified by z00161729 for DTS2013101007129, 2013-10-11, end */
    NAS_OTA_MSG_MM_INFO,
    NAS_OTA_MSG_MM_RR_CONNECTION,
    /* Added by t00212959 for DTS2013019107530, 2013-2-1, begin */
    NAS_OTA_MSG_REEST_REQ,
    /* Added by t00212959 for DTS2013019107530, 2013-2-1, end */
...
typedef struct
{
    /* Modified by s00217060 for cs_err_log, 2014-09-28 Begin */
    VOS_UINT8                           ucSmsMr;
    VOS_UINT8                           aucReserve[3];
    VOS_UINT32                          ulCause;
    /* Modified by s00217060 for cs_err_log, 2014-09-28 End */
...
/*modified by z40661 for DTS2012102501504, 2012-11-01, begin*/
typedef struct
{
...
/*modified by z40661 for DTS2012102501504, 2012-11-01, end*/
/*OTA相关*/
typedef struct
{
    VOS_MSG_HEADER

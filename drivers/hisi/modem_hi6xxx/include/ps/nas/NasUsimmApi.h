...
VOS_UINT32 NAS_USIMMAPI_AuthReq(
    ...
    VOS_UINT8                          *pucRand,
    /* modified by l65478 for DTS2013121919477 2013-11-30 begin */
    VOS_UINT8                          *pucAutn,
    VOS_UINT8                           ucOpId
    /* modified by l65478 for DTS2013121919477 2013-11-30 end */
);
...
/* Modified by n00269697 for enhanced conference, 2014-11-28, Begin */
...
VOS_UINT32 NAS_PBAPI_QryECallNumber(
    VOS_UINT32                          ulPid,
...
/* Added by y00213812 for CDMA 1X Iteration 1, 2014-8-20, begin */
#if (FEATURE_UE_MODE_CDMA == FEATURE_ON)
VOS_UINT32 NAS_PIHAPI_RegCsimCardStatusIndMsg(
    VOS_UINT32                          ulRegPID
);
#endif
/* Added by y00213812 for CDMA 1X Iteration 1, 2014-8-20, end */

...
/* Modified by w00176964 for V7R1C50 GUL BG, 2012-4-28, begin */
#define RRC_MAX_HIGH_PLMN_NUM           (48)                /* 高质量的PLMN的最大个数 */
#define RRC_MAX_LOW_PLMN_NUM            (48)                /* 低质量的PLMN的最大个数 */
/* Modified by w00176964 for V7R1C50 GUL BG, 2012-4-28, end */
...
/*Added by L00167020 for DTS2010070900358,2010-08-28,begin*/
#define MS_RADIO_ACCESS_CAPABILITY_MIN_SIZE                (6)    /* RAC消息最小长度 */
#define MS_RADIO_ACCESS_CAPABILITY_MAX_SIZE                (52)   /* RAC消息最大长度 */
/*Added by L00167020 for DTS2010070900358,2010-08-28,end*/
...
/*Added by s46746 for DTS2011042004956, 2011-5-11, begin*/
#define NAS_RRC_MAX_EHPLMN_NUM          (32)                /* 支持的最大EHPLMN个数 */
/*Added by s46746 for DTS2011042004956, 2011-5-11, end*/

/* Added by w00176964 for V7R1C50 GUL BG, 2012-4-27, begin */
#define NAS_RRC_MAX_RAT_NUM                             (3)                     /* 当前支持的接入技术个数 */
/* Added by w00176964 for V7R1C50 GUL BG, 2012-4-27, end */
...
/* MM发给AS的原语 */
    ...
    /* Modified by t00212959 for DTS2012041801803, 2012-11-15, begin */
    RRMM_TRANSACTION_INFO_ENQ           = 0x006E,   /* _H2ASN_MsgChoice RRMM_TRANSACTION_INFO_ENQ_STRU */
    /* Modified by t00212959 for DTS2012041801803, 2012-11-15, end */
    /* Added by w00176964 for V7R1C50_GUTL_PhaseI, 2012-7-16, begin */
    RRMM_UTRAN_MODE_REQ                 = 0x0070,   /* _H2ASN_MsgChoice RRMM_UTRAN_MODE_REQ_STRU */
    /* Added by w00176964 for V7R1C50_GUTL_PhaseI, 2012-7-16, end */
    ...
    /* Modified by z00161729 for DTS2014032105704, 2014-3-22, begin */
    RRMM_REL_CS_PS_ALL_CONN_REQ         = 0x0078,   /* _H2ASN_MsgChoice RRMM_REL_CS_PS_ALL_CONN_REQ_STRU */
    /* Modified by z00161729 for DTS2014032105704, 2014-3-22, end */

    /* Modified by z00161729 for DSDS III, 2014-6-16, begin */
    ...
    /* Modified by z00161729 for DSDS III, 2014-6-16, end */

    /* Modified by z00161729 for DTS201405090133, 2014-5-22, begin */
    RRMM_SERVICE_ABORT_NOTIFY        = 0x0080,  /* _H2ASN_MsgChoice RRMM_SERVICE_ABORT_NOTIFY_STRU */
    /* Modified by z00161729 for DTS201405090133, 2014-5-22, end */

    /* Modified by w00242748 for DTS2014050900899, 2014-5-22, begin */
    ...
    /* Modified by w00242748 for DTS2014050900899, 2014-5-22, end */
    /* Add by j00174725 for DTS2015053000044, 2015-06-01, begin */
    RRMM_TRANSACTION_STATUS_NOTIFY     = 0x0088,   /* _H2ASN_MsgChoice RRMM_TRANSACTION_STATUS_NOTIFY_STRU */
    /* Add by j00174725 for DTS2015053000044, 2015-06-01, end */
    ...
    /* Added by w00176964 for V7R1 Phase II,2011-07-13,begin*/
    GRRGMM_GPRS_ACCESS_RESULT_IND       = 0x0075,   /* _H2ASN_MsgChoice GRRGMM_GPRS_ACCESS_RESULT_IND_STRU */
    /* Added by w00176964 for V7R1 Phase II,2011-07-13,end*/
...
enum RRC_NAS_AREA_LOST_ENUM
{
    ...
    /*added by y00176023 for DSDS II,2014-03-29,begin*/
    RRC_NAS_NO_RF_AREA_LOST    = 2,                /* 由于NO RF导致的掉网 */
    RRC_NAS_AREA_LOST_BUTT
    /*added by y00176023 for DSDS II,2014-03-29,end*/
};
...
enum RRC_NAS_IDNNS_TYPE_ENUM
{
	...
	/* Modified by z00161729 for DTS2011091702442, 2012-10-10, begin */
    ...
    /* Modified by z00161729 for DTS2011091702442, 2012-10-10, end */
...
enum RRC_NAS_EST_RESULT_ENUM
{
    ...
    /* Added by w00167002 for DTS2013081604476, 2013-8-22, begin */
    RRC_EST_RJ_T3122_RUNNING            = 14,               /* G下立即指派被拒启动T3122，在T3122运行期间回复建联请求 */
    /* Added by w00167002 for DTS2013081604476, 2013-8-22, end */

    /*added by y00176023 for DSDS II,2014-03-27,begin*/
    RRC_EST_RJ_NO_RF                       = 15,               /* 由于RF不可用导致的RRC建立失败 */
    /*added by y00176023 for DSDS II,2014-03-27,end*/

    /*added by l00256032 for DTS2014070904196, 2014-7-15,begin*/
    RRC_EST_RJ_SNW                       = 16,               /* AS搜网状态RRC回复建链失败 */
    /*added by l00256032 for DTS2014070904196, 2014-7-15,end*/

    /* Modified by z00161729 for DTS2014080104539, 2014-8-14, begin */
    RRC_EST_RANDOM_ACCESS_REJECT_NO_VALID_INFO        = 17,   /* 仅G下使用，未同步完成邻区 */
    /* Modified by z00161729 for DTS2014080104539, 2014-8-14, end */

    /*added by z00234330 for CS ERRORLOG, 2014-8-20,begin*/
    ...
    /*added by z00234330 for CS ERRORLOG, 2014-8-20,end*/
...
enum RRC_REL_CAUSE_ENUM
{
    ...
    /* Added by w00167002 for DTS2015011400748, 2015-1-28, begin */
    RRC_REL_CAUSE_G_RL_FAIL                     = 24,       /* 仅G下使用，Radio link失败，不触发呼叫重建 */
    /* Added by w00167002 for DTS2015011400748, 2015-1-28, end */
...
/*Modified by w00176964 for V7R1 Phase II,2011-07-11,begin*/
/*****************************************************************************
 枚举名    : RRC_NAS_AC_TYPE_ENUM
...
/*Modified by w00176964 for V7R1 Phase II,2011-07-11,end*/
...
/* Modified by z40661 for DTS2012053006110, 2012-06-02, begin */
...
/* Modified by z40661 for DTS2012053006110, 2012-06-02, end */
...
enum NAS_GSM_MASK_ENUM
{
    ...
    /* Modified by s00217060 for DTS2014042406145, 2014-4-24, begin */
    NAS_GSM_MASK_MAPPED_SECURITY_KEY    = 0x0400,           /* LTE下映射过来的安全上下文有效标志 */
    /* Modified by s00217060 for DTS2014042406145, 2014-4-24, end */
    NAS_GSM_MASK_BUTT
};
...
/* Added by b00269685 for sys info modify, 2015-6-10, begin */
/*****************************************************************************
...
/* Added by b00269685 for sys info modify, 2015-6-10, end */

/* Added by w00176964 for V7R1 PhaseIII,2011-10-25,begin */
/*****************************************************************************
...
/* Added by w00176964 for V7R1 PhaseIII,2011-10-25,end*/
...
/* Added by g00166634 for V7R1 CSFB,begin */
/* Modified by t00212959 for DTS2012041801803, 2012-11-15, begin */
/*****************************************************************************
...
/* Added by w00176964 for  V7R1C50_GUTL_PhaseII, 2012-8-30, begin */
/*****************************************************************************
...
/* Added by w00176964 for  V7R1C50_GUTL_PhaseII, 2012-8-30, end */

/* Added by w00176964 for DTS2011082405001, 2012-10-30, begin */
/*****************************************************************************
...
/* Added by w00176964 for DTS2011082405001, 2012-10-30, end */
...
/* Add by j00174725 for DTS2015040705043, 2015-05-12, begin */
/*******************************************************************************
...
/* Add by j00174725 for DTS2015040705043, 2015-05-12, End */
...
typedef struct
{
    ...
    /* Added by w00176964 for DTS2011082405001, 2012-11-1, begin */
    RRC_NAS_COVERAGE_TYPE_ENUM_UINT32   enCoverageType;     /* RRC在当前接入技术下的网络覆盖类型 */
    /* Added by w00176964 for DTS2011082405001, 2012-11-1, end */
...
/* Modified by l00130025 for DTS2012050301244, 2012-05-10 begin */
...
typedef struct
{
    ...
    /* modified by l65478 for DTS2013062406563 2013-06-27 begin */
    RRC_PLMN_ID_LIST_STRU               stPlmnIdList;    /* 上报的W/G/L PLMN ID列表 */
    /* modified by l65478 for DTS2013062406563 2013-06-27 end */
}RRMM_LIMIT_SERVICE_CAMP_IND_STRU;

/* Modified by l00130025 for DTS2012050301244, 2012-05-10 end*/
...
typedef struct
{
    ...
    /* Modified by w00167002 for V7R1 phase II , 2011-06-28, begin */
    ...
    /* Modified by w00167002 for V7R1 phase II , 2011-06-28, end */
...
/* Modified by w00176595 for DTS2012122600751, 2012-12-27, begin */
...
/* Modified by w00176595 for DTS2012122600751, 2012-12-12, end */
/*****************************************************************************
...
typedef struct
{
    ...
    /* Modified by w00176595 for DTS2012122600751, 2012-12-12, begin */
...
/* Added by l00130025 for DTS2012032004389, 2012-04-21 begin */
/***********************新增接口GMM－>GAS********************************
...
/* Added by l00130025 for DTS2012032004389, 2012-04-21 end*/
...
/* Modified by z00161729 for DTS2013082907281, 2013-10-17, begin */
/*****************************************************************************
...
/* Modified by z00161729 for DTS2013082907281, 2013-10-17, end */
...
typedef struct
{
    ...
    /* Modified by z00161729 for DTS2013082907281, 2013-10-11, begin */
    VOS_UINT32                          bitOpCurPlmn: 1;                        /* 指示stCurCampedPlmnId字段是否有效，手动搜网模式下
                                                                                   如果当前驻留网络不是用户指定plmn则该值为0，当前驻留网络无效 */
    VOS_UINT32                          bitSpare     : 31;
    RRC_PLMN_ID_STRU                    stCurCampedPlmnId;
    /* Modified by z00161729 for DTS2013082907281, 2013-10-11, end */
...
/* Modified by w00176964 for V7R1 PhaseIII,2011-10-25,begin */
/*******************************************************************************
...
typedef struct
{
    ...
    /* Modified by w00166186 for V7R1C50 AT&T&DCM, 2012-6-11, begin */
    VOS_UINT32                          bitOpHPlmn          : 1;
    VOS_UINT32                          bitOpEHPlmn         : 1;
    VOS_UINT32                          bitSpare            : 26;
    /* Modified by w00166186 for V7R1C50 AT&T&DCM, 2012-6-11, end */

    RRC_NAS_USIM_STATUS_ENUM_UINT32                         enUsimStatus;       /* 标志USIM卡的状态 */
    /* Modified by l00208543 for RatBlackListAccordSimType, 2013-11-01, begin */
    ...
    /* Modified by l00208543 for RatBlackListAccordSimType, 2013-11-01, end */
...
/* Modified by w00176964 for V7R1 PhaseIII,2011-10-25,end */
...
/* Modified by w00167002 for V7R1 phase II , 2011-07-12, begin */
...
/* Modified by w00167002 for V7R1 phase II , 2011-07-12, end */
...
/*Added by y00142674 for customize, 2009-08-08 Begin*/
extern VOS_VOID GASGCOM_UpdateCustomizeNv(VOS_VOID);
/*Added by y00142674 for customize, 2009-08-08 End*/

/*Added by w00146666 for DTS2014022101274, 2014-02-27, begin*/
...
extern VOS_UINT32 GASGCOM_GetMsCapability(RRC_PLMN_ID_STRU *pstPlmn,
                                               ...
                                               VOS_UINT16 usSize,
                                               VOS_UINT8 *pucData);
/*Added by w00146666 for DTS2014022101274, 2014-02-27, end */
#endif

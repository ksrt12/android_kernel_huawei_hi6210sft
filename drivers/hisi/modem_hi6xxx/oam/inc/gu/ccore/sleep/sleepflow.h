...
#define SLEEP_ACTIVATE_ERROR_ID                 (9)
...
/* Added by L00256032 for V8R1 LowPower&NV_Expand Project, 2014-03-14, begin */
...
/* Added by L00256032 for V8R1 LowPower&NV_Expand Project, 2014-03-14, end */
...
typedef struct
{
    ...
    VOS_UINT32                                  aulDevicePwState[SLEEP_CHANNEL_BOTH][SLEEP_GU_MODE_TYPE_BUTT][PWC_COMM_MODULE_BUTT][PWC_COMM_CHANNEL_BUTT];
    VOS_UINT32                                  aulDeviceUpSlice[SLEEP_CHANNEL_BOTH][SLEEP_GU_MODE_TYPE_BUTT][PWC_COMM_MODULE_BUTT][PWC_COMM_CHANNEL_BUTT];
    VOS_UINT32                                  aulDeviceDownSlice[SLEEP_CHANNEL_BOTH][SLEEP_GU_MODE_TYPE_BUTT][PWC_COMM_MODULE_BUTT][PWC_COMM_CHANNEL_BUTT];
    VOS_UINT32                                  aulPllPwState[SLEEP_CHANNEL_BOTH][SLEEP_GU_MODE_TYPE_BUTT][PWC_COMM_MODULE_BUTT][PWC_COMM_CHANNEL_BUTT];
    VOS_UINT32                                  aulPLLUpSlice[SLEEP_CHANNEL_BOTH][SLEEP_GU_MODE_TYPE_BUTT][PWC_COMM_MODULE_BUTT][PWC_COMM_CHANNEL_BUTT];
    VOS_UINT32                                  aulPLLDownSlice[SLEEP_CHANNEL_BOTH][SLEEP_GU_MODE_TYPE_BUTT][PWC_COMM_MODULE_BUTT][PWC_COMM_CHANNEL_BUTT];
...
/*****************************************************************************
 结构名    : SLEEP_CCPU_SLEEP_STATE_STRU
 结构说明  : GU模当前器件状态
*****************************************************************************/
typedef struct
{
    VOS_UINT32                                  ulGetFlag;
    SLEEP_RECORD_STRU                           stCcpuSleepState;
    SLEEP_RECORD_STRU                           stCcpuAwakeState;
}SLEEP_CCPU_SLEEP_STATE_STRU;
...
extern VOS_UINT32 SLEEP_CCPUSleepGetState( SLEEP_CCPU_SLEEP_STATE_STRU    *pstState );
...
VOS_VOID SLEEP_CCPUSuspend( VOS_VOID );
VOS_VOID SLEEP_CCPUResume( VOS_VOID );

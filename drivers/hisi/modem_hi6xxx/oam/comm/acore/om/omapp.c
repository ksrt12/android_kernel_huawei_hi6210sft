...
/* Added by j00174725 for BBP数采项目，2012-12-03，Begin */
...
/*****************************************************************************
 Prototype      : OM_AcpuSendDataCbtChannel
 Description    : OM sends the data to tool side.
 Input          : pucMsg      - 待发送数据.
                  usMsgLen    - 数据长度.
 Output         : void
...
/*****************************************************************************
 Prototype      : OM_AcpuSendDataChannel
 Description    : OM sends the data to tool side.
 Input          : enChannel      - 逻辑通道.
                  pucMsg         - 待发送数据.
                  usMsgLen       - 数据长度.
 Output         : void
 Return Value   : VOS_OK - Success.
...
/*****************************************************************************
 Prototype      : OM_AcpuSendResultChannel
 Description    : OM sends the execution result to tool side.
 Input          : enChannel       - logic channel
                  ucFuncType      - The function type of msg.
                  ulResult        - The execution result.
                  usReturnPrimId  - The returned PrimId.
 Output         : void
...
/*****************************************************************************
 Prototype      : OM_AcpuSendContentChannel
 Description    : OM sends the execution content to tool side.
 Input          : enChannel      - logic channel
                  ucFuncType     - The pointer of the sequence number.

...
typedef struct RTC_TIMER_DEBUG_INFO_STRU
{
    VOS_UINT16      usPid;
    VOS_UINT16      usName;
    VOS_UINT32      ulSlice;
} RTC_TIMER_DEBUG_INFO;
...
#if (OSA_CPU_CCPU == VOS_OSA_CPU)
extern VOS_VOID PAMOM_LogSaveTimer( VOS_UINT8 *pBuf, VOS_UINT32 ulLen );
#endif
                            ...
                            VOS_UINT32 Para2, VOS_UINT32 Para3 )
{
    ...
    RTC_TIMER_DEBUG_INFO        stDebugInfo;
    ...
    for(;;)
    {
        ...
        while ( VOS_NULL_PTR != RTC_TimerCtrlBlkexpired )
        {
            ...
            stDebugInfo.usPid   = (VOS_UINT16)RTC_TimerCtrlBlkexpired->Pid;
            stDebugInfo.usName  = (VOS_UINT16)RTC_TimerCtrlBlkexpired->Name;
            stDebugInfo.ulSlice = VOS_GetSlice();
...
#if (OSA_CPU_CCPU == VOS_OSA_CPU)
            PAMOM_LogSaveTimer(&(stDebugInfo), sizeof(stDebugInfo));
#endif

...
/* Added by f00179208 for At Project, 2011-10-26, Begin */
/* A核和C核编解码都要用到 */
#include  "MnMsgTs.h"
/* Added by f00179208 for At Project, 2011-10-26, End */
/* Added by s00217060 for VoLTE_PhaseIII, 2013-12-13, begin */
#include "TafStdlib.h"
/* Added by s00217060 for VoLTE_PhaseIII, 2013-12-13, end */
...
/*****************************************************************************
  3 宏定义
*****************************************************************************/
/* Deleted by w00176964 for SS FDN&Call Control, 2013-5-20, begin */

/* Deleted by w00176964 for SS FDN&Call Control, 2013-5-20, end */
...
)
{
    ...
    /* Modified by f00179208 for At Project, 2011-10-26, Begin */
    if ('+' == pcMmiStr[0])
    {
        /*将Ascii码转换成对应的BCD码*/
    ...
    /* Modified by f00179208 for At Project, 2011-10-26, End */
...
)
{
    ...
    /* deleted by l65478 for DTS2012021604543 2012-02-16 begin */
    /* deleted by l65478 for DTS2012021604543 2012-02-16 end */

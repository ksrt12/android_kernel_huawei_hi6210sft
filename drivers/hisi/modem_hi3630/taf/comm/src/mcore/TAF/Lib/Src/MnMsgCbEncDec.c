...
)
{
    ...
    {
        /* Modified by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-4-5, begin */

        /* Modified by l00171473 for DTS2012041103201, 2012-4-11, begin */
        pstCbmPageInfo->stContent.ulLen = (ulDataLen * 8)/7;
        /* Modified by l00171473 for DTS2012041103201, 2012-4-11, end */

        if ( pstCbmPageInfo->stContent.ulLen > TAF_CBA_MAX_RAW_CBDATA_LEN )
        {
            pstCbmPageInfo->stContent.ulLen = TAF_CBA_MAX_RAW_CBDATA_LEN;
        }
        /* Modified by l00171473 for V7R1C50 CSFB&PPAC&ETWS&ISR, 2012-4-5, end */

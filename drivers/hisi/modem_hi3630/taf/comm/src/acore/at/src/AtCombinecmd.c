...
VOS_VOID At_ResetCombinCmdInfo(HI_LIST_S* pstCombList)
{
    ...
    /* Modified  by l00130025 for DTS2011120703681, 2011-12-25, begin */
    ...
    {
        /* DTS2012091101219 c64416 start in 2012-10-12 for At_ResetCombinCmdInfo */
        if(me == NULL)
        {
        ...
        /* DTS2012091101219 c64416 end in 2012-10-12 for At_ResetCombinCmdInfo */
    }
...
VOS_VOID At_ResetCombinParseInfo(VOS_UINT8 ucIndex)
{
    ...
    /* Modified  by l00130025 for DTS2011120703681, 2011-12-25, end */
...
static VOS_UINT32 At_StoreSubCombCmd(HI_LIST_S* pstCombList, VOS_UINT8 *pDataIn, VOS_UINT16 usLenIn)
{
    ...
    /* DTS2012053103326 c64416 start in 2012-05-31 for ATTTTT */
    pstCombineCmdInfo = msp_list_entry(pstCombList, AT_FW_COMBINE_CMD_INFO_STRU, stCombineCmdList);
    ...
    /* DTS2012053103326 c64416 end in 2012-05-31 for ATTTTT */
    ...
    /* DTS2012053103326 c64416 del in 2012-05-31 for ATTTTT */
    pstCombineCmdInfo->usTotalNum++;
...
VOS_UINT32 At_SemicolonCmdParse(HI_LIST_S* pstCombList, VOS_UINT8 *pDataIn, VOS_UINT16 usLenIn)
{
    ...
    /* Added by l00198894 for DTS2013100901373, 2013/10/12, begin */
    else
    {
        At_UpStringCmdName(pDataIn, 1);
    }
    /* Added by l00198894 for DTS2013100901373, 2013/10/12, end */
...
/* added by l65478 for DTS2013050800550 2013-05-13 begin */
/*****************************************************************************
...
)
{
    ...
    /* Modified by f62575 for DTS2013121606723 2013-12-16 begin */
    usBeginPos = 3;
    ...
    /* Modified by f62575 for DTS2013121606723 2013-12-16 End   */
...
/* added by l65478 for DTS2013050800550 2013-05-13 end */

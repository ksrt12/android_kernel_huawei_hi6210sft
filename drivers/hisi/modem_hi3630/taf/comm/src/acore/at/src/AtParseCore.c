...
/* Modified by f62575 for DTS2012112010227 2012-11-19, begin */
...
/* modify by j00174725 for Clean Warning, 2012-07-22, End */
/* Modified by f62575 for DTS2012112010227 2012-11-19, end   */
...
VOS_UINT32 AT_ParseCmdIsPend(VOS_UINT8 ucIndex, VOS_UINT8 *pData, VOS_UINT16 usLen)
{
    ...
    for (i = 0; i < AT_MAX_CLIENT_NUM; i++)
    {
        ...
        if (i == ucIndex)
        {
            ...
            {
                /* Added by f62575 for DTS2012061505515, 2012-06-19, Begin */
                CmdStringFormat(ucIndex, pData, &usLen);
                /* Added by f62575 for DTS2012061505515, 2012-06-19, End */
...
VOS_VOID AT_ResetParseVariable(VOS_VOID)
{
    ...
    /* Added by o00132663 for At Project, 2011-10-28, Begin */
...
AT_RRETURN_CODE_ENUM_UINT32 fwCmdTestProc(VOS_UINT8 ucIndex, AT_PAR_CMD_ELEMENT_STRU* pstCmdElement)
{
    ...
    if(NULL != pstCmdElement->pfnTestProc)
    {
        ...
        if(AT_WAIT_ASYNC_RETURN == ulResult)
        {
            ...
            /* Added by w00242748 for NETSCAN, 2013-10-23, begin */
            At_SetAtCmdAbortTickInfo(ucIndex, VOS_GetTick());
            /* Added by w00242748 for NETSCAN, 2013-10-23, end */
        }
...
VOS_UINT32 LimitedCmdProc(VOS_UINT8 ucClientId, VOS_UINT8 *pData, VOS_UINT16 usLen, AT_PAR_CMD_ELEMENT_STRU* pstCmdElement)
{
    ...
    /* DTS2012021200290 c64416 start in 2012-03-22 for limited AT CMD */
    ...
    /* Modified by f00179208 for DTS2012032702424, 2012-04-07 Begin */
    ...
    /* Modified by f00179208 for DTS2012032702424, 2012-04-07 End */
    ...
    /* DTS2012021200290 c64416 end in 2012-03-22 for limited AT CMD */
...
VOS_UINT32 CmdParseProc(VOS_UINT8 ucClientId, VOS_UINT8 *pData, VOS_UINT16 usLen)
{
    ...
    /* DTS2012051201779 c64416 del in 2012-05-31 for CPBW */
...
VOS_UINT32 ScanBlankChar( VOS_UINT8 *pData, VOS_UINT16 *pLen)
{
    ...
    VOS_UINT8  *pWrite        = pData;
    VOS_UINT8  *pRead         = pData;
    /* DTS2012020303603 c64416 start in 2012-02-08 for """ */
    VOS_UINT16 usChkLen       = 0;
    /* DTS2012020303603 c64416 end in 2012-02-08 for """ */
    VOS_UINT16 usLen          = 0;
...
/* Added by c64416 for DTS2012102905864 , 2012-10-31, Begin */
/*****************************************************************************
...
/* Added by c64416 for DTS2012102905864 , 2012-10-31, End   */
...
VOS_BOOL CheckAnyCharCmdName(VOS_UINT8 *pData, VOS_UINT16* pusLen, VOS_UINT8 *plName, VOS_UINT8 *pbName)
{
    ...
    /* Modified by f00179208 for V9R1 split AT head file, 2012-10-19 begin */
    if (bFound)
    {
    ...
    /* Modified by f00179208 for V9R1 split AT head file, 2012-10-19 end */
...
)
{
    ...
    /* Modified by w00167002 for NETSCAN, 2013-10-31, begin */

    /* 检测当前打断tick值是否满足相隔125ms条件,如果不满足，则直接返回不打断 */
    if  ( ulAtCurrSetTick >= pstCmdAbortTick->ulAtSetTick[ucIndex] )
    {
    /* Modified by w00167002 for NETSCAN, 2013-10-31, end */

...
const AT_RETURN_TAB_TYPE_STRU gastAtReturnCodeTab[]=
{
    ...
    /* Modified by z60575 for DTS2012072102200 at 2012/7/24 Begin */
    ...
    /* Modified by z60575 for DTS2012072102200 at 2012/7/24 end */
    ...
    /* Added by s00217060 for DTS2012060507813, 2012-11-08, begin */
    {AT_CME_CS_SERV_EXIST,                                 {(TAF_UINT8*)"302"  ,(TAF_UINT8*)"CS SERVICE EXIST"                         }  },
    /* Added by s00217060 for DTS2012060507813, 2012-11-08, end */
...
)
{
    ...
    /* Added by j00174725 for UART-MODEM Project, 2013-09-25, begin */
    else if(AT_HSUART_USER == gastAtClientTab[ucIndex].UserType)
    {
        AT_HSUART_SendDlData(ucIndex, gstAtSendDataBuffer, usLen);
    }
    /* Added by j00174725 for UART-MODEM Project, 2013-09-25, end */
#endif
    /* Modified by L60609 for MUX，2012-08-13,  Begin */
    else if(VOS_TRUE == ulHsicUserFlg)
    /* Modified by L60609 for MUX，2012-08-13,  End */
...
)
{
    ...
    /* Modified by j00174725 for UART-MODEM Project, 2013-09-25, end */
    {
        ...
        else if (AT_CTR_USER == gastAtClientTab[ucIndex].UserType)
        {
            ...
            if (0 == gucAtPortSel)
            {
                /*modified by w00181244 for DTS2012021305344, 2012-2-24, begin*/
                DMS_COM_SEND(AT_CTR_PORT_NO, gstAtSendDataBuffer, usLen);
                /*modified by w00181244 for DTS2012021305344, 2012-2-24, end*/
            }
        }
        else if (AT_MODEM_USER == gastAtClientTab[ucIndex].UserType)
        {
    ...
    VOS_UINT32                          ulReturnCode)
{
    ...
    {
        /* Modified by l00171473 for V7R1C50_At_Abort, 2012-9-24, begin */
        /* 提取函数降复杂度 */

        AT_FormatAtCmdNotSupportResult(ucIndex, (AT_RRETURN_CODE_ENUM_UINT32)ulReturnCode);
        /* Modified by l00171473 for V7R1C50_At_Abort, 2012-9-24, end */
    ...
    /* Added by L60609 for AT Project，2011-10-24,  End*/
    /* Modified by y00213812 for V7R1C50 A-GPS Project, 2012/06/27, begin */
    if ((AT_WAIT_SMS_INPUT == ulReturnCode)/* 进入SMS输入模式 */
        || (AT_WAIT_XML_INPUT == ulReturnCode))/* 进入XML文本输入模式 */
    {
    /* Modified by y00213812 for V7R1C50 A-GPS Project, 2012/06/27, end */
...
)
{
    ...
    {
        /* Modified by L00171473 for DTS2011092204540, 2011-12-13, begin */
        case PS_PTL_VER_R99:
        case PS_PTL_VER_R3:
        case PS_PTL_VER_R4:
            enRateIndex = PPP_RATE_DISPLAY_R99;
            break;
        /* Modified by L00171473 for DTS2011092204540, 2011-12-13, end */

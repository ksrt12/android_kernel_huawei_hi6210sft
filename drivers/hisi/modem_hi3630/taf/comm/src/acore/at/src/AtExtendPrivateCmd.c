...
/* SMS */
    ...
    /* modified by y00213812 for AP-Modem Personalisation Project, 2012/04/18, begin */
    {AT_CMD_OPWORD,
    AT_SetOpwordPara,       AT_SET_PARA_TIME,  VOS_NULL_PTR,             AT_NOT_SET_TIME,   VOS_NULL_PTR, AT_NOT_SET_TIME,
    VOS_NULL_PTR,   AT_NOT_SET_TIME,
    AT_CME_INCORRECT_PARAMETERS,       CMD_TBL_PIN_IS_LOCKED,
    (VOS_UINT8*)"^OPWORD",      VOS_NULL_PTR},
    /* modified by y00213812 for AP-Modem Personalisation Project, 2012/04/18, end */
...
/* DTS2012031509135            : x00126983 2012-3-15 AT^PDPROFMOD + */
   ...
   /* DTS2012031509135            : x00126983 2012-3-15 AT^PDPROFMOD - */
#endif
    /* Added by L60609 for DTS2012040504057, 2012-4-24, Begin   */
    {AT_CMD_SCID,
    ...
    /* Added by L60609 for DTS2012040504057, 2012-4-24, End   */
    ...
    /* Modified by z60575 for DTS2012050902198,2012-05-12, begin */
    {AT_CMD_DISSD,
    ...
    /* Modified by z60575 for DTS2012050902198,2012-05-12, end */
...
/* HUAWEI 移动宽带产品终端设备一键升级接口规范V1.07.doc 文档涉及的命令底软未归一: V700R001版本使用LTE的实现，V300R002版本使用GU模的实现 */
 ...
 /* Added by d00212987 for BalongV9R1 NV备份数据丢失容错&恢复 2013-10-24, end */
    ...
    /* Modified by f62575 for DTS2012050800608, 2012-5-10, Begin   */
    {AT_CMD_IPV6CAP,
    ...
    /* Modified by f62575 for DTS2012050800608, 2012-5-10, End   */

    /* Modified by w00199382 for DTS2012042404319, 2012-4-26, begin */
    {AT_CMD_DHCPV6,
    ...
    /* Modified by w00199382 for DTS2012042404319, 2012-4-26, end */
...
/* Added by f62575 for AT Project,2011-10-17,  End*/
    ...
    /* Added by z40661 for DTS2011113007424,2012-04-26, Begin*/
    /* 支持5中形态的语音类型 */
    {AT_CMD_VMSET,
    ...
    /* Modified by A00165503 for DTS2013071002570, 2013-07-10, Begin */
    (VOS_UINT8*)"^VMSET",       (VOS_UINT8*)"(0-8)"},
    /* Modified by A00165503 for DTS2013071002570, 2013-07-10, End */
    /* Added by M00217266 for B180 DELIVERY, 2013-8-29, End */
    /* Added by z40661 for DTS2011113007424,2012-04-26, end*/

    /* Modified by w00199382 for DTS2012050307304, 2012-05-07, Begin */
    {AT_CMD_CVOICE,
    ...
    /* Modified by w00199382 for DTS2012050307304, 2012-05-07, End */
    ...
    /* Modified by z00161729 for DTS2013102403705, 2013-10-25, begin */
    {AT_CMD_DTMF,
    ...
    /* Modified by z00161729 for DTS2013102403705, 2013-10-25, end */
    ...
    /* Modified by w00167002 for DTS2011100804309, 2011-12-22, begin */
    ...
    /* Modified by w00167002 for DTS2011100804309, 2011-12-22, end */
    ...
    /* Modified by c64416 for DTS2012040200965, 2012-4-27, begin */
    {AT_CMD_CARDMODE,
    ...
    /* Modified by c64416 for DTS2012040200965, 2012-4-27, end */
    ...
    /* Added by l00198894 for AT Project,2011-11-1 Begin */
    {AT_CMD_USIM,
    ...
    /* Added by l00198894 for AT Project,2011-11-1 End */
    ...
    /* Added by z00234330 for dts2014012003529,2014-01-22 begin */
    {AT_CMD_CGCATT,
    ...
    /* Added by z00234330 for dts2014012003529,2014-01-22 end */
    ...
    /* Modified by w00167002 for DTS2013071600742, 2013-7-16, begin */
    ...
    /* Modified by w00167002 for DTS2013071600742, 2013-7-16, end */
    ...
    /* Added by w00176964 for v7r1 phaseIV,2011-12-01,begin */
    {AT_CMD_SYSINFOEX,
    ...
    /* Added by w00176964 for v7r1 phaseIV,2011-12-01,end */
...
/* Modified by w00176964 for V7R1 PhaseIV, 2012-2-2, begin */
#if   (FEATURE_ON == FEATURE_LTE)
    {AT_CMD_SYSCFGEX,
...
#endif
/* Modified by w00176964 for V7R1 PhaseIV, 2012-2-2, end */
...
/* Modified by l00198894 for PS Project, 2012/01/19, begin */
    /* Modified by s62952 for BalongV300R002 Build优化项目 2012-02-28, end */

    {AT_CMD_AUTHDATA,
    At_SetAuthdataPara, AT_SET_PARA_TIME, AT_QryAuthdataPara, AT_QRY_PARA_TIME, At_TestAuhtdata, AT_NOT_SET_TIME,
    VOS_NULL_PTR,   AT_NOT_SET_TIME,
    /* Modified by Y00213812 for DTS2013021702572, 2013-02-17, begin */
    AT_CME_INCORRECT_PARAMETERS, CMD_TBL_PIN_IS_LOCKED,
    /* Modified by Y00213812 for DTS2013021702572, 2013-02-17, end */
    (VOS_UINT8*)"^AUTHDATA", (VOS_UINT8*)AUTHDATA_CMD_PARA_STRING},
/* Modified by l00198894 for PS Project, 2012/01/19, end */
    ...
    /* Modified by w00199382 for DTS2012041206043, 2012-4-26, begin */
    {AT_CMD_NDISDUP,
    ...
    /* Modified by w00199382 for DTS2012041206043, 2012-4-26, end */

    /* Modified by f00179208 for DTS2012073000337, 2012-07-31 Begin */
    /* Modified by f00179208 for DTS2012032107203, 2012-03-27 Begin */
    {AT_CMD_NDISCONN,
    ...
    /* Modified by f00179208 for DTS2012032107203, 2012-03-27 End */
    /* Modified by l60609 for DTS2012050501603,2012-5-7,End */
    /* Modified by f00179208 for DTS2012073000337, 2012-07-31 End */
...
/* Modified  by z60575 for DTS2012031400889, 2012-4-30, end */
...
/* Added by l00198894 for C50_IPC Project, 2012/02/16, end */
    ...
    /* 与K3对接命令 */
    /* Modified by l00198894 for DTS2013020700423, 2013/02/07, begin */
    {AT_CMD_CSASM,
    ...
    /* Modified by l00198894 for DTS2013020700423, 2013/02/07, end */
    ...
    /* Modified by n00269697 for VTLTE, 2014-06-16, Begin */
    {AT_CMD_APDS,
    ...
    /* Modified by n00269697 for VTLTE, 2014-06-16, End */
    ...
    /* Modified by j00174725 for enhanced conference, 2014-11-28, End */
...
VOS_UINT32 AT_TestNetScan( VOS_UINT8 ucIndex )
{
    gstAtSendData.usBufLen = (VOS_UINT16)At_sprintf(AT_CMD_MAX_LEN,
                                       (VOS_CHAR *)pgucAtSndCodeAddr,
                                       (VOS_CHAR *)pgucAtSndCodeAddr,
    /* Modified by w00242748 for DTS2013112202356, 2013-12-2, begin */
                                       "%s: (1-20),(-110--47),(0,1)",
    /* Modified by w00242748 for DTS2013112202356, 2013-12-2, end */
                                       g_stParseContext[ucIndex].pstCmdElement->pszCmdName
                             );

...
/* Added by m00217266 for L-C互操作项目, 2014-2-10, begin */
#define RNIC_RAB_ID_IS_VALID(ucRabId)\
    (((ucRabId) >= RNIC_RAB_ID_MIN) && ((ucRabId) <= RNIC_RAB_ID_MAX))
/* Added by m00217266 for L-C互操作项目, 2014-2-10, end */

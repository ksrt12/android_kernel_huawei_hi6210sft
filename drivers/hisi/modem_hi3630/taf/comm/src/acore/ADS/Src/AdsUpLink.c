...
/*****************************************************************************
 函 数 名  : ADS_UL_StartRptStatsInfoTimer
 功能描述  : 启动统计信息上报定时器
 输入参数  : VOS_VOID
 输出参数  : 无
 返 回 值  : VOS_VOID
...
/*****************************************************************************
 函 数 名  : ADS_UL_StopRptStatsInfoTimer
 功能描述  : 停止上报统计信息定时器
 输入参数  : VOS_VOID
 输出参数  : 无
 返 回 值  : VOS_VOID
...
/*****************************************************************************
 ...
 修改历史      :
  ...
  4.日    期   : 2012年8月30日
    作    者   : l60609
    修改内容   : AP适配项目：增加FEATURE_SKB_EXP特性打开的处理
...
/*****************************************************************************
 函 数 名  : ADS_UL_RcvCdsStopSendDataInd
 功能描述  : 处理ID_CDS_ADS_START_SENDDATA_IND消息
 输入参数  : MsgBlock *pMsg
 输出参数  : 无
 返 回 值  : VOS_UINT32
 调用函数  :
...
/*****************************************************************************
 函 数 名  : ADS_UL_RcvCdsClearDataInd
 功能描述  : 处理ID_CDS_ADS_CLEAR_DATA_IND消息
 输入参数  : MsgBlock *pMsg
 输出参数  : 无
 返 回 值  : VOS_UINT32
 调用函数  :
...
/*****************************************************************************
 函 数 名  : ADS_UL_RcvTiRptStatsInfoExpired
 功能描述  : 上报统计信息定时器超时处理

...
/*****************************************************************************
 ...
 功能描述  : IMM MEM申请函数
 输入参数  : unsigned int ulFileID    申请的文件名
             unsigned int ulLineNum   申请的行号
             unsigned int ulPid       对应的Pid
             unsigned int ulPoolId    对应的内存池
